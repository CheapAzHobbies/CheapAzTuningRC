...
> **Running: the Traxxas TRA6736 Rustler 4x4 front bumper with the TRA9044 rear skid.** The front is **a real divergence** from the [FastAzJato4x4](../FastAzJato4x4/bumper_analysis.md), which runs the **RPM 81042 wide front** instead. **The rear is not a divergence**, both cars run the same 9044.
>
...
## The front bumper options

All of these bolt to the same Slash 4x4 / Jato 4x4 mount pattern. Mike runs the **TRA6736**.
...
| ❌ ~~**TRA6736X**~~ | The LED bumper and support version, same problem, one character from the part you want | $10.00 |

</div>

> ⚠️ **Watch the part number when ordering.** **TRA6736X is not a variant of TRA6736, it is the LED one.** The front bumper takes direct hits, so lights mounted in it are destroyed almost immediately, which is why both LED options are ruled out rather than merely disliked.

---

## Notes

- **Hinge-pin retention is the hard requirement, not impact protection.** The bumpers hold the arm hinge pins in their bores on this chassis family, so running without them is a mechanical failure rather than a weight saving. They barely weigh anything anyway. This is what locks them into the [BOM](BOM.md#chassis--bracing) regardless of any crash argument.
