...
- **The alloy front bulkhead is not optional here.** FLM arms strip a plastic bulkhead, and this car's chassis is plastic, so the **Powerhobby alloy front** is the part that makes the whole arm choice work. See [`chassis_analysis.md`](chassis_analysis.md).
