...
> **Running: custom axles built from chopped E-Revo 1.0 CVDs**, the same build as the [FastAzJato4x4](../FastAzJato4x4/driveshaft_analysis.md#shortening--joining-e-revo-cvds-custom-axles-wip). Length is dialled on an adjustable threaded prototype, then the final axles are welded to that length. **Shorter axle goes to the front.**
>
...
<p align="center"><img src="../FastAzJato4x4/src/drivetrain_traxxas_e_revo_cvd_5451r.jpg" height="140">&nbsp;<img src="../FastAzJato4x4/src/drivetrain_traxxas_output_shaft_6752_long.jpg" height="140">&nbsp;<img src="../FastAzJato4x4/src/drivetrain_traxxas_center_driveshaft_6855.jpg" height="140">&nbsp;<img src="../FastAzJato4x4/src/drivetrain_tekno_1654-17_front_hub_adapter.jpg" height="140">&nbsp;<img src="../FastAzJato4x4/src/drivetrain_tekno_5580_stub_axle.jpg" height="140"><br><em>What goes into an axle here: <strong>E-Revo CVD 5451R</strong> donor · <strong>TRA6752</strong> long output shafts · <strong>TRA6855</strong> alloy centre shaft · Tekno <strong>TKR1654-17</strong> front stub · Tekno <strong>5580</strong> rear stub</em></p>
...
- **Shorter axle goes to the front.** The two ends are not interchangeable once they are cut and welded to length.
