...
- ⚠️ **The C number on the label is fiction, and the packs here prove it.** The **90C** Racing 5200 measured better than the **120C** Ultra-Thin, and the cheapest pack in the fleet has the best IR. Every label above overstates by a wide margin, so **read the IR and treat the C-rating as marketing**. The arithmetic behind that is in the [FastAz C-rating math](../FastAzJato4x4/battery_analysis.md#the-c-rating-math-a-fun-sanity-check), and the method used to get the measured figures is the [E-Revo IR-to-True-C walkthrough](../ERevo_1.0/battery_analysis.md#c-ratings-and-internal-resistance).
