...
| ⭐ **Steel upper brace, VG Racing style** — *running* | **Material:** steel<br>**CG:** N/A<br>**Fits:** Slash 4x4 / Jato 4x4 platform<br>**Includes:** brace only<br>**Weight:** N/A 🚧 not weighed<br>**Price:** N/A 🚧 not recorded | Pro: **Replaces the other part that actually breaks.** The OEM upper brace fails often enough that swapping it is routine, and steel ends the problem outright<br><br>Con: Heavier than the OEM plastic, and it sits high, so the weight is in the worst place for CG. **No part number**, it is sourced by style rather than SKU | <img src="https://placehold.co/500x300/eee/333?text=IMAGE+NEEDED" width="500"><br>🚧 save as `src/chassis_vg_racing_steel_upper_brace.jpg` |
