...
<p align="center">
  <img src="src/suspension_mugen_mbx8te-lower-arms_rc57532.jpg" width="500">&nbsp;<img src="src/drivetrain_mugen_diff-gear-set-44t_e2244_1.jpg" width="500"><br>
...
Now that the car is a **truggy**, the `MBX8Te` (MBX8 Truggy electric) arm + turnbuckle bags are spot-on. The nitro `E2712` is still useless (electric car). This looks like a seller who also ran an **MBX7/MGT** car for years, which is where the deep MBX7 hoard came from, and it doesn't belong to this truggy.
