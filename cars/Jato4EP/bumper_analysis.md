...
> **Bumper and skid plate describe the same part.** They bolt to the same places and take the same ground contact. What separates them is how much each one actually does, and some do very little. The labels below mark positions on the car.

<div align="center">

| Item | Part | Price |
|---|---|---|
| **Front bumper** | **Traxxas TRA6736**, Rustler 4x4 front with support, glass-filled nylon | **$6.00 each** |
| **Rear skid** | **Traxxas TRA9044**, sold as a front and rear set, the rear half runs | **$7.00 / set** |
| **Front skid** | The Rustler bumper covers this, so the 9044 front plate stays in the box | included in the set |
| **Rear bumper** | The rear skid does this job | included in the set |

</div>

> **The 9044 rear is the only rear plate that covers the tongue.** Everything else wraps the edges of the rear end and leaves the tongue bare, and the tongue is what drags on a bad landing. That one detail decides the rear on both cars.
>
> **The rear does very little now, and that suits the car.** **Most of the damage happens up front.** The rear only has to slide, so a separate rear bumper would add weight for nothing.
