...
<p align="center"><img src="src/electronics_traxxas_battery_holddown_7426x_kit.jpg" height="200">&nbsp;<img src="src/electronics_battery_bar_3d_printed.jpg" height="200"><br><em>The stock <strong>Traxxas 7426X</strong> kit, extended bar plus both retainers, what the <strong>4S</strong> car ships with (the <strong>2S</strong> gets the shorter <strong>7426</strong>) · the 3D printed bar that runs alongside it</em></p>
...
> **Where the design comes from.** The bar is the [Traxxas Slash 4x4 LCG XL Battery Hold Down](https://www.printables.com/model/305527-traxxas-slash-4x4-lcg-xl-battery-hold-down) model **305527** on Printables. **The listing targets the LCG chassis and the XL hold down**, which matches this car: it runs the **7422 LCG** tub, and the bar has to clear a **47mm pack under a 44mm ceiling**. 🚧 Designer and licence not recorded; Printables blocks automated fetches. The STL is not vendored into this repo; print it from the source.
