...
<p align="center"><img src="../Jato4SS/src/electronics_gensace_redline2_4s_6300_140c.webp" height="150">&nbsp;<img src="../Jato4SS/src/electronics_cnhl_racing_4s_5200_90c.png" height="150">&nbsp;<img src="../Jato4SS/src/electronics_cnhl_lightning_4s_5500_120c_hv.png" height="150">&nbsp;<img src="../Jato4SS/src/electronics_cnhl_ultrathin_4s_6000_120c_hv.png" height="150"><br><em>The four packs that run here: Gens Ace Redline 6300 · CNHL Racing 5200 · CNHL Lightning 5500 · CNHL Ultra-Thin 6000</em></p>
...
**Soft case or hard case, either runs here**, unlike the 4SS which went hardcase-only because of the sand at Meldrum. That car is shorty-only too, so the two no longer buy to one shared spec.

> ⚠️ **The measured sizes do not all fit the stated envelope.** Dimensions come from the [4SS pack comparison](../Jato4SS/battery_analysis.md#pack-comparison), where these three were logged when they came off that car.
>
...
|:---|:---|:---|:---|
| ⭐ **Gens Ace Redline 2.0 4S HV 15.2V 6300mAh 140C** — *on loan from the 4SS* | **Cells:** 4S HV / **15.2V** (4.35V/cell)<br>**Config:** **4S1P**<br>**ROAR:** ✅<br>**Capacity:** 6300mAh (**95.76Wh**)<br>**C-rating:** 140C (marketing)<br>**Weight:** **452g**<br>**Connector:** 5.0mm bullet<br>**Size:** **139 × 47 × 37mm** full length hardcase<br>**Price:** **$107.38** (2025-10-22) | Pro: **The best pack that runs here.** HV, low IR, light for a 6300, and at **37mm tall it clears the 44mm ceiling with 7mm to spare**. Never fitted the 4SS shorty-only spec, so it found its home on this car<br><br>Con: **5.0mm bullet**, the odd one out against the CNHL fleet's EC5. Needs an HV charger. **On loan**, it may just become Mike's outright | <img src="../Jato4SS/src/electronics_gensace_redline2_4s_6300_140c.webp" width="500"> |
| 🟢 **CNHL Ultra-Thin Racing LiHV 4S 15.2V 6000mAh 120C** — *hardcase* | **Cells:** 4S / **15.2V LiHV**<br>**Config:** **4S1P**<br>**ROAR:** ❌<br>**Capacity:** 6000mAh (91.20Wh)<br>**C-rating:** 120C / 240C burst (marketing)<br>**Weight:** **479g**<br>**Connector:** EC5, 10AWG<br>**Size:** **138 × 47 × 37mm** hardcase<br>**Price:** **$71.00** (2026-08-26) | Pro: **Most capacity of the CNHL three**, hardcase, and HV confirmed on the charger. Fits and works well<br><br>Con: **The worst measured IR of the group at ~4.48mΩ**, which estimates out around **11-19C against the 120C on the label**. Priciest CNHL here | <img src="../Jato4SS/src/electronics_cnhl_ultrathin_4s_6000_120c_hv.png" width="500"><br><em>the pack</em><br><img src="src/electronics_cnhl_ultrathin_6000_120c.jpg" width="500"><br><em>per-cell IR at 100% charge</em> |
| 🟢 **CNHL Lightning LiHV 4S 5500mAh 120C** — *soft case* | **Cells:** 4S / **15.2V LiHV**<br>**Config:** **4S1P**<br>**ROAR:** ❌<br>**Capacity:** 5500mAh<br>**C-rating:** 120C / 240C burst (marketing)<br>**Weight:** **472g**, the lightest here<br>**Connector:** EC5, 10AWG<br>**Size:** **149 × 51 × 31mm** soft case<br>**Price:** **$54.46** (2026-08-26) | Pro: Fits and works well, mid capacity of the three, and the listing sells it as LiHV, so it should be in the better group<br><br>Con: **The only pack here never put on the charger for an IR check**, so its voltage class is listing-only and its C figure is unknown | <img src="../Jato4SS/src/electronics_cnhl_lightning_4s_5500_120c_hv.png" width="500"> |
| 🟢 **CNHL Racing Series 4S 5200mAh 90C** — *soft case* | **Cells:** 4S, **reads LiHV (4.35V) on the charger**<br>**Config:** **4S1P**<br>**ROAR:** ❌<br>**Capacity:** 5200mAh<br>**C-rating:** 90C / 180C burst (marketing)<br>**Weight:** **524g**, the heaviest here<br>**Connector:** EC5, 10AWG<br>**Size:** **160 × 45 × 37mm** soft case<br>**Price:** **$52.51** (2026-08-26) | Pro: **Much the best IR of the group at ~2.23mΩ**, an estimated **26-43C**, so it holds voltage best under load despite carrying the lowest label rating. Cheapest pack here<br><br>Con: **Heaviest pack here at 524g**, and the longest at 160mm, though **being only 37mm tall it passes under the bar's curve and fits anyway**. ⚠️ **Sold as a standard LiPo and listed as 14.8V on the 4SS, but this car's charger reads it as LiHV**, so the sources disagree | <img src="../Jato4SS/src/electronics_cnhl_racing_4s_5200_90c.png" width="500"><br><em>the pack</em><br><img src="src/electronics_cnhl_racing_5200_90c.jpg" width="500"><br><em>per-cell IR mid-charge</em> |

</div>

### IR checks

Measured on the HOTA T6, using the [E-Revo IR-to-True-C method](../ERevo_1.0/battery_analysis.md#c-ratings-and-internal-resistance) (`max A = sag ÷ IR`, `C = max A ÷ Ah`). **The IR is measured, the C figure is calculated from it**, so treat it as an estimate rather than a reading. **Informational only**, the CNHL packs are not in the shared cycle tracker.

<div align="center">

| Pack | Per-cell IR | Average | Estimated C | Label |
|---|---|---|---|---|
...
> **The listing and the charger disagree on the Racing 5200.** It is sold as a standard LiPo, but the charger reads **LiHV (4.35V)**. Both CNHL packs that have been checked read HV, so the Lightning 5500 is probably HV too, but it has never been on the charger to confirm.
...
- ⚠️ **The C number on the label is fiction, and the packs here prove it.** The **90C** Racing 5200 measured better than the **120C** Ultra-Thin, and the cheapest pack in the fleet has the best IR. Every label above overstates by a wide margin, so **read the IR and treat the C-rating as marketing**. The arithmetic behind that is in the [4SS C-rating math](../Jato4SS/battery_analysis.md#the-c-rating-math-a-fun-sanity-check), and the method used to get the measured figures is the [E-Revo IR-to-True-C walkthrough](../ERevo_1.0/battery_analysis.md#c-ratings-and-internal-resistance).
- **Going up the C scale buys less and less.** Most people would not feel the difference between a **30C** pack and a **90C** one, even though the label triples. The car draws what the motor and the throttle ask for and no more, and both packs hand that over without strain, so the extra headroom sits unused. The number starts to matter only when a pack is bad enough to sag under what the car actually pulls. That is why the step from the Ultra-Thin's **4.48mΩ** down to the Racing's **2.23mΩ** shows up in the driving, while shaving another milliohm off the Racing would be hard to feel at all. Picture a kinked garden hose against an open one: opening the kink changes everything, and swapping that open hose for a slightly wider one changes almost nothing. **Once a pack is decent, paying for a bigger C number buys very little.**
- **Sharing works one way.** Shorties fit this car too, so anything bought to the 4SS spec runs here, while the full length packs stay on this one.
...
- **Hardcase is the likely direction.** Two of the four packs here are soft case, and soft packs are what chafe: grit works into the tray and wears the shrink wrap. **Moving to hardcase, the CNHL hardpack being the obvious one, would remove that worry entirely.** It is the same reasoning that pushed the [Jato 4SS](../Jato4SS/battery_analysis.md) to hardcase-only for the sand at Meldrum, so this car would be catching up.
