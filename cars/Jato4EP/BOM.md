...
| Part | Qty | Source | Price | Doc |
|---|---|---|---|---|
| **Traxxas 7422 LCG chassis**<br><sub>Note: the tub the Jato 4x4 ships with anyway. ⚠️ LCG, so only LCG parts fit</sub> | 1 | [LEDGER](../../LEDGER.md) #80 | **$20.00 each** | [Chassis](chassis_analysis.md) |
...
| **S605ZZ 5×14×5 ABEC-9 stainless bearings**<br><sub>Note: the motor bearings for the Castle 1412. **The motor takes two, the same size front and rear, and a service replaces both**, so a full service is **$3.42**. Bought as a 10-pack at $17.06, which is five services. ⚠️ **unique to this car**, since the 4SS runs a different motor</sub> | 2 | AliExpress, Bearing Solution Store | **$1.71 each** | [Bearings](bearings_reference.md#the-motor-bearing-s605zz) |
