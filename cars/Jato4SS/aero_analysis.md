...
- Reference: the K939 build uses the older Slash 4x4-style rear shock geometry, that platform has *not* had the rear-shock crash exposure problem the Jato 4SS prototype hit with the Jato stock tower. **That exposure has since been designed out.** The rear shocks now mount ahead of the tower in the Slash position rather than hung off the back, so the tower leads and the shock sits behind it ([`shock_tower_analysis.md`](shock_tower_analysis.md)).
