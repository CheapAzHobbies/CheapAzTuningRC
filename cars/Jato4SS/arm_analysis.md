# Suspension Arm Selection — Jato 4SS
...
|---|---|---|---|
| 🟢 **TRA6732** Front Arm Guards — *bought from Tammies, running on the [K939](../K939/README.md)* | **Part:** TRA6732<br>**Material:** Composite, lightweight<br>**Position:** Front<br>**Fits:** Slash 4x4 (listed for Stampede 4x4); also RPM arms<br>**Weight:** N/A<br>**Price:** **$9.95** | Pro: **No front bumper on this build, front shocks and arms are exposed. These are essential.** Protects shocks and arms from frontal impacts, including accidental contact with other cars on track. Shields against debris kicked up by the car in front. Keeps grass out of driveshafts. Includes all hardware<br><br>Con: Adds a tiny amount of weight, negligible in practice since it's plastic | <img src="src/suspension_traxxas_arm_guards_tra6732.jpg" width="500"> |
| 🟢 **TRA6733** Rear Arm Guards — *bought from Tammies, running on the [K939](../K939/README.md)* | **Part:** TRA6733<br>**Material:** Composite<br>**Position:** Rear<br>**Fits:** Slash 4x4 / Jato 4x4 pattern<br>**Weight:** N/A<br>**Price:** **$7.00** | Pro: Same composite construction as front. Shields rear driveline from dirt and rocks being thrown up into it<br><br>Con: Adds a tiny amount of weight, negligible in practice since it's plastic | <img src="src/suspension_traxxas_arm_guards_rear_tra6733.jpg" width="500"> |
...
|---|---|---|---|
| 2026-07-02 | **$25.73/pair** ✅ **purchased** | **FLM July 1st sale, 25% off** ($30→$22.50/pair before shipping). Bulk order, 4 pairs, $120 subtotal − $30 discount + $12.90 shipping = $102.90 total | Order #4658, direct from FLM. 1 of the 4 pairs went to [Mike's Jato 4x4](../Jato4EP/README.md) (tracked in [`/LEDGER.md`](../../LEDGER.md#mike--running-account), not here); remainder is this build's front (+ spares). **Annual sale, see [`Deals/flm_july_sale_2026.md`](../../Deals/flm_july_sale_2026.md), check again next July.** |
...
- **The exception, and it's worth knowing: the shock mount can change wheelbase.** The arms don't, but **if you're running the Slash 4x4 style shock mount rather than the Jato 4x4 one, the car comes out about 5mm longer**. That's mount position, not arm length, so everything above still holds; it just means the two setups don't measure the same end to end. **Keep it in mind as extra wheelbase on top of the extra track**, since a longer car is that bit more stable in a straight line and that bit lazier to rotate. Which mount you have also drives the [rear tower choice](shock_tower_analysis.md), where the Slash geometry is preferred anyway for putting the shocks ahead of the tower.
