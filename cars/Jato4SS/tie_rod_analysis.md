...
| ❌ ~~**Traxxas 5538 steel toe link**~~ — *the Jato specific one* | **Type:** Threaded turnbuckle, **61mm**, comes assembled with rod ends and pillow balls<br>**Material:** Steel<br>**MPN:** Traxxas **5538**<br>**Fits:** **Jato pattern**, which is what this car is<br>**Adjustable:** Yes<br>**Length:** **61mm**<br>**Price:** **$8.50 / pair** | Pro: **The Jato part rather than a Rustler or Stampede one**, same 61mm and same price as the 3645<br><br>Con: Steel, so it carries the same bending and snapping problem as the 3645. Being the correct application does not make it survive the FLM arm | <img src="https://placehold.co/460x300/eee/333?text=TRA5538+PHOTO+NEEDED" width="300"><br>🚧 save as <code>src/steering_traxxas_toe_link_steel_5538.jpg</code> |
...
<p align="center"><img src="src/steering_camber_link_measurements_collage.jpg" width="700"><br><em>Top row, the bare rods. Bottom row, the same links assembled. Columns are <strong>ST Link</strong>, the front steering link · <strong>CAM Link</strong>, the rear camber link · <strong>ST Link 2</strong>, the front camber link</em></p>
