...
| 🟢 **SkyRC B6neo** (Global Ltd, SK-100198) | DC 200W / PD 80W, 1-6S, LiHV<br>70×50×32mm, 150g, CE | The original B6neo, same as the B6neo+ bar the **200W** rating. Tiny/portable, easy to use, cheap. Honestly I keep the neos for the **color options** (blue / pink / green / grey), which the T6 doesn't have. DC/PD source needed. <img src="src/electronics_skyrc_b6neo_charger.jpg" width="150"> |
