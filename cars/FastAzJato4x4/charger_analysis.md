...
- **Input voltages:** all run on **DC ~10-30V**, so a **12V car battery** or a 12/24V supply works on any of them (the B6neo+ goes down to 5V, the M7 down to 7V). Only the **B6ACneo takes AC mains (100-240V)**. The T6 / neos also accept **USB-C PD** as input.
