...
|---|---|---|---|
| ⭐ **HOTA T6** | **Chemistries:** LiHV/LiPo/LiFe/LiIon, NiMH/NiCd/NiZn, Pb, Smart<br>**Cells:** 1-6S Li (1-14S NiMH)<br>**Power:** DC 300W / PD 90W<br>**Channels:** 1 (single)<br>**Max current:** 15A<br>**Interfaces:** XT60 + USB-C in; 2.4" IPS; 70.5×49.5×30.5mm, 93g<br>**Price:** **~$28-33** (own 2; got one for $28 recently) | Pro: **The current best**, all the features, does everything, tiny (93g). **Cheaper and stronger than the neos.** Runs off USB-C PD or a 12V car battery<br><br>Con: **Single channel** (one pack at a time). No color options. Needs a DC/PD source. Charge-vs-Balance menu confuses at first (see notes) | <img src="src/electronics_hota_t6_charger.jpg" width="250"> |
| 🟢 **SKYRC B6ACneo** (SK-100200) | **Chemistries:** LiPo/LiFe/LiIon/LiHV/NiMH/NiCd/Pb, Smart<br>**Cells:** 1-6S Li (1-15S NiMH, Pb 3-6S)<br>**Power:** DC 200W / **AC 60W** / **PD out 65W** (discharge 19W)<br>**Channels:** 1<br>**Max current:** 0.2-10A<br>**Interfaces:** **AC 100-240V (wall)** + DC 10-30V; 1.77" TN 128×160 color; PC-ABS V0 shell; 70.6×50.6×46mm, 150g<br>**Price:** ~$42 | Pro: **The only one you plug straight into the wall (AC)**, no PD brick or supply. The modern **upgrade of the classic iMAX B6AC**, with full protections (short / over-V / over-temp / capacity). Can also **output 65W USB-C PD** to charge a phone / laptop off it. Grab-and-go for quick charges<br><br>Con: Lower power on AC (60W). Single channel | <img src="src/electronics_skyrc_b6acneo_charger.jpg" width="250"> |
