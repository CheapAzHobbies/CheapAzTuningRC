...
|---|---|---|---|---|
| **FLM Extended Rear Arms** FLM26800 | CNC billet 6061 aluminum. Extended length: +~10mm wheelbase per arm. Pin-to-pin: 78.1mm / 82.55mm (adjustable width). Extra shock positions. Made in USA. $30.00 (list $40.00) | **Chosen** | Pro: **Only arm that extends the wheelbase** — ~10mm per side increases droop by a large margin, massive handling improvement. Makes the Jato feel like a proper race car vs expensive buggies at a fraction of the weight. **Cost math: bend it back 3 times and you've already saved money over buying shorter stock arms that snap more often.** Bends instead of snaps — still in the race, not stranded. Adjustable width, extra shock positions, USA-made CNC quality<br><br>Con: Strips bulkhead on hard impacts. Tie rods snap — needs 4mm tie rod upgrade (separate analysis). Rear only — front needs a separate solution. Bent geometry is close but not factory perfect — fine for bashing, less ideal for precision racing | <img src="src/suspension_flm_rustler_rear_extended_arms_flm26800.jpg" width="500"> |
| **Traxxas Slash 4x4 OEM Arms** TRA3655X | Hardened plastic. 100mm × 45mm × 11.5mm. Front or rear. $10 (RC Superstore) | Candidate | Pro: Stiff — sharp steering response, consistent geometry. $10, stocked at every hobby store, works front and rear<br><br>Con: Breaks more easily than EHD — brittle nylon mix snaps on hard hits. **Shorter than FLM26800** — no wheelbase extension, no extra droop | <img src="src/suspension_traxxas_slash4x4_oem_arms_tra3655x.jpg" width="500"> |
| **Traxxas 1/10 Heavy Duty Arms** TRA3655-BLK | Proprietary composite. Stock length. Slash / Rustler / Stampede / Jato 4x4. $12.00. In stock AMain (Aug 2025) | Candidate | Pro: Current in-stock successor to discontinued TRA3655R. Same HD composite flex formula. $12, available in black / blue / green / orange<br><br>Con: Stock length — no wheelbase extension, no extra droop vs FLM26800. Still shorter than the chosen arm | <img src="https://placehold.co/500x300/eee/333?text=IMAGE+NEEDED" width="500"><br>🚧 save as `src/suspension_traxxas_hd_arms_tra3655-blk.jpg` |
| ~~**Traxxas Heavy Duty Arms** TRA3655R~~ | Proprietary composite with flex additive. Stock length. Front/rear 4x4, rear 2WD. $12.00 | Ruled Out | Pro: Stronger than OEM TRA3655X — proprietary composite flexes instead of snapping, works cold weather. $12<br><br>Con: **Discontinued online** — AMain lists it as discontinued. Same length as OEM, no wheelbase extension | <img src="src/suspension_traxxas_slash4x4_hd_arms_tra3655r.jpg" width="500"> |
| ~~**Pro-Line ProTrac 4x4 Suspension Arms** PRO6082-01~~ | Nylon. Front + rear in one set (usable either position). Fits Slash 4x4 / Stampede 4x4 with ProTrac kit. $13.75 | **Ruled Out** | Pro: Ideal arm — would be the first choice if available. Front + rear covered by one part number. $13.75 for a set<br><br>Con: **Discontinued — unobtanium.** Can't source replacements for a race car. No point building around a part you can't replace when it breaks | <img src="src/suspension_proline_protrac_arms_pro6082-01.webp" width="500"> |
| ~~**RPM Arms** RPM80702~~ | Flexible nylon compound | Vetoed | Pro: Great for bashing — flexibility absorbs impacts instead of snapping. Won't break<br><br>Con: Too flexible for a race car — flex that saves the arm transfers load into the driveshafts. Thinner CVDs (e.g. Tekno) and custom axles will bend under that flex. **E-Revo CVDs are double the thickness of Tekno and would survive**, but the overall flex characteristic isn't what this build wants — loses the rigid race car feel the FLM arms deliver | <img src="src/suspension_rpm_arms_rpm80702.jpg" width="500"> |
