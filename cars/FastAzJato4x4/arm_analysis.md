...
| ~~**RPM Arms** RPM80702~~ | Flexible nylon compound | Vetoed | Pro: Great for bashing — flexibility absorbs impacts instead of snapping. Won't break<br><br>Con: **Too flexible for custom CVDs and extended axles** — the flex bends the driveshafts and custom axles, not the arm. **Only compatible with stock-style driveshafts.** This build runs E-Revo CVDs — not usable here | <img src="src/suspension_rpm_arms_rpm80702.jpg" width="500"> |
