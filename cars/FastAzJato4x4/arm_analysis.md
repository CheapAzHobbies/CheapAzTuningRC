...
|---|---|---|---|---|
| **FLM Extended Rear Arms** FLM26800 | CNC billet 6061 aluminum, extended length. Pin-to-pin: 78.1mm / 82.55mm (adjustable width). Made in USA. $30.00 (list $40.00) | **Candidate (in build description, likely lead)** | Pro: USA-made CNC billet aluminum, extended length for 1/8-buggy-class wheelbase. Adjustable width for setup flexibility. Extra shock mount positions. $30 with free US shipping over $100. **Expected first-to-break part on this build — aluminum bends under big impacts rather than shattering, better failure mode than catastrophic snap**<br><br>Con: Rear only — front needs a paired option. Aluminum arms transfer more force to hinge pins than nylon. Harder to source than Traxxas stock | <img src="src/suspension_flm_rustler_rear_extended_arms_flm26800.jpg" width="500"> |
