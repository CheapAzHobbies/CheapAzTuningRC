...
| ~~**TRA3655** Standard wheelbase original~~ | Original nylon. Stock length. $9.99 (discontinued AMain) | Ruled Out | Pro: **Stiffest plastic arm overall** — stiffer than the current TRA3655X. Would be the first choice for a race build purely on stiffness. $9.99<br><br>Con: **Discontinued** — same problem as PRO6082-01. Can't source replacements when they break. Same length as OEM, no wheelbase extension | <img src="src/suspension_traxxas_oem_original_arms_tra3655.jpg" width="500"> |
