...
| **TRA3655X** Standard wheelbase OEM | Hardened plastic. 100mm × 45mm × 11.5mm. Front or rear. $10 (RC Superstore) | Candidate | Pro: **Easiest to source stiff arm** — decently stiff, good steering response and consistent geometry. $10, stocked everywhere, works front and rear<br><br>Con: Breaks more easily than EHD or FLM — brittle nylon snaps on hard hits. Stock length, no wheelbase extension | <img src="src/suspension_traxxas_slash4x4_oem_arms_tra3655x.jpg" width="500"> |
