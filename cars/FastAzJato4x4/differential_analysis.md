...
> **Chosen:**
> - **Front & rear diffs: Traxxas Jato 4x4 stock diffs — back to stock.** 5mm outdrives now match the **Slash 4x4-pattern CVDs / Tekno M6 stub axle build** we're actually running (see [`driveshaft_analysis.md`](driveshaft_analysis.md)). Native Jato 4x4 fit, cheapest assembled option (~$12.97). The E-Revo 1.0 diffs (6mm) are already owned but drop to spares/fallback — the CVD plan moved to 5mm.
...
|---|---|---|---|
| ⭐ **Traxxas Jato 4x4 stock diffs** | **Outdrive:** **5mm**<br>**Housing:** Plastic<br>**Internals:** TRA6882 gear set (same as XO-1); ring gear TRA6879<br>**Part:** TBD for Slash variant<br>**Fits:** Native Jato 4x4 / Slash 4x4<br>**Price:** ~$12.97 assembled (Jato 4x4, Jenny's RC, 5 in stock) | Pro: **Back to stock — 5mm now matches the Slash 4x4-pattern CVDs / Tekno M6 stub axle build we're actually running.** Native fit, no gearbox-housing fitting needed. Cheapest assembled diff here. Same TRA6882 gear set as XO-1<br><br>Con: Same TRA6882 internals as XO-1, so no real upgrade over the XO-1 diff other than price/fit | <img src="src/drivetrain_traxxas_jato_4x4_stock_diff.jpg" width="500"> |
