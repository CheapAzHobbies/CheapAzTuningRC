...
> **Chosen:**
> - **Front & rear diffs: Traxxas E-Revo 1.0** (TRA3978 carrier + TRA5382X gear set) — stock diff already includes the I-bar/spider gear braces. 6mm outdrives mate with the chosen E-Revo CVDs. All other diffs (Jato 4x4, Slash 4x4, XO-1) use 5mm outdrives and are ruled out.
...
|---|---|---|---|---|
| **Traxxas E-Revo 1.0 diffs** | Outdrive: **6mm**<br><br>Carrier: TRA3978 (includes steel spider gear braces / I-bar — stock)<br><br>Gear set: TRA5382X (output gears, spider gears, spider gear shaft)<br><br>**Front and rear are identical parts** — same diff, buy 2 | **Chosen — In Hand** | Pro: **Only 6mm outdrive diff that mates the in-hand E-Revo CVDs.** I-bar spider gear braces come stock — no separate XO-1 swap needed. **Plastic housing stays rounder longer than aluminum** — holds fluid better, more tolerant to minor bending. 1/8-class internals in a 1/10 chassis — overbuilt for the role. $0 cost (already in hand)<br><br>Con: Heavier than stock Jato diffs; E-Revo diff cases require minor fitting to the Jato gearbox housing. **Must fill half full only** — overfilling plastic diff housings causes them to explode under pressure (user error, not a design flaw) | <img src="src/drivetrain_traxxas_e_revo_diff_carrier_tra3978.jpg" width="500">&nbsp;<img src="src/drivetrain_traxxas_e_revo_diff_gear_set_tra5382x.jpg" width="500"><br><em>TRA3978 carrier · TRA5382X gear set</em> |
| ~~**Traxxas XO-1 diffs**~~ | Outdrive: **5mm**<br><br>Internal: I-bar cross pin<br><br>Part numbers: TBD | Ruled Out | Pro: I-bar spider gear braces<br><br>Con: **5mm outdrives — same incompatibility as Jato/Slash stock diffs.** E-Revo stock diff already includes the I-bar via TRA3978 carrier, so there's no reason to source XO-1 parts separately | <img src="https://placehold.co/500x300/eee/333?text=IMAGE+NEEDED" width="500"><br>🚧 save as `src/drivetrain_traxxas_xo1_diff.jpg` |
