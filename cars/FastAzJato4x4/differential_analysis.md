...
> - **Center diff: AliExpress metal center diff (~$20) with 20k wt oil.** Fully assembled, and its **integrated steel 54T spur is the build's spur** (no separate spur to fit). The lighter TRA6814 plastic is the alternative.
> - **Spur gear: the integrated steel 54T spur on the AliExpress center diff.** The separate **TRA3956R 54T plastic spur (in hand) is now a spare**. This trades the plastic-fuse failure mode for the cheap all-in-one metal center diff.
...
> **Chosen: AliExpress metal center diff (alum body + integrated steel 54T spur), ~$20, 20k wt oil.** One cheap fully-assembled unit that includes the spur, so there is no separate spur to buy or fit. It trades the lighter TRA6814 plastic (and the plastic-fuse failure mode) for a cheap all-in-one metal diff, a tradeoff taken knowingly. The TRA6814 OEM plastic is the lighter alternative if you would rather keep the separate plastic spur fuse.
...
> **Decision changed: running the integrated steel 54T spur that comes on the [AliExpress metal center diff](#center-diff).** So the build has no separate spur, and the **TRA3956R 54T plastic spur (in hand) is now a spare**. This trades away the plastic-fuse failure mode below for a cheap all-in-one metal center diff, a tradeoff taken knowingly. The plastic-spur analysis is kept for reference (and it's the setup to revert to if the steel spur ever chews the pinion/driveline).
>
> **Plastic-spur reference (the TRA3956R 54T, now a spare):** plastic is a sacrificial failure point, in a bad crash it strips before transferring force to the metal pinion, driveshafts, and gearbox. 54T over 50T/52T: **more teeth spread the load and wear more evenly**, and **54T lands the gearing where we want it.** Cheap to replace.
