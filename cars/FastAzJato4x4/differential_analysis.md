...
> **Chosen:**
> - **Front & rear diffs: Traxxas Jato 4x4 stock diffs (5mm outdrive).** The build briefly planned 6mm E-Revo 1.0 diffs, but the axle plan settled on **5mm Slash 4x4-pattern CVDs on Tekno M6 stubs** (see [`driveshaft_analysis.md`](driveshaft_analysis.md)), so the diffs have to be 5mm to match. The stock Jato 4x4 diff is the native-fit, cheapest assembled 5mm option (~$12.97). The 6mm E-Revo 1.0 diffs (already owned) drop to spares unless the axle plan ever moves back to 6mm.
> - **Center diff: stock Traxxas TRA6814 (OEM plastic) with 20k wt oil** — lighter than the alum+steel units and proven across several of my builds.
...
<p align="center"><img src="src/drivetrain_traxxas_jato_4x4_stock_diff.jpg" height="240">&nbsp;<img src="src/drivetrain_traxxas_center_diff_tra6814.jpg" height="240">&nbsp;<img src="src/drivetrain_traxxas_spur_gear_tra3956r_54t.jpg" height="240"><br><em>The chosen drivetrain: stock Jato 4x4 front/rear diff · TRA6814 OEM plastic center diff · TRA3956R 54T plastic spur</em></p>
...
|---|---|---|---|
| ⭐ **Traxxas Jato 4x4 stock diffs** | **Outdrive:** **5mm**<br>**Housing:** Plastic<br>**Internals:** TRA6882 gear set (same as XO-1); ring gear TRA6879<br>**Part:** assembled Jato 4x4 diff (part # TBD 🚧); rebuild = TRA6882 gear set + TRA6879 ring gear<br>**Fits:** Native Jato 4x4 / Slash 4x4<br>**Price:** ~$12.97 assembled (Jato 4x4, Jenny's RC, 5 in stock) | Pro: **Stock 5mm outdrive matches the Slash 4x4-pattern CVDs / Tekno M6 stub axle build the car runs.** Native fit, no gearbox-housing fitting needed. Cheapest assembled diff here. Same TRA6882 gear set as XO-1<br><br>Con: Same TRA6882 internals as XO-1, so no real upgrade over the XO-1 diff other than price/fit | <img src="src/drivetrain_traxxas_jato_4x4_stock_diff.jpg" width="500"> |
