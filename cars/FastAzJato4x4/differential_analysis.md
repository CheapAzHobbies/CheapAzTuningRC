...
| **AliExpress Heavy Duty Centre Diff (alum body + steel 54T spur)** | Brand: Tolex (generic)<br><br>Housing: aluminum<br><br>Spur: steel 54T (integrated)<br><br>Fully assembled<br><br>Price: **~$15–20** ($15.23 sale / $23.43 list)<br><br>Fits: Slash 4x4 / Hoss 4x4 VXL | **2nd choice** | Pro: **Fully assembled for ~$20** — a cheap knock-off of the $69.95 TRA6780. If you want a complete drop-in for the price of the TRA6814 build, this is it<br><br>Con: Heavier — **alum body + steel spur add rotational weight** vs the preferred lighter OEM plastic diff, and aluminum augers out faster than plastic. Fine as a cheap backup, but the OEM plastic is the better pick | <img src="src/drivetrain_aliexpress_center_diff_alum_steel.jpg" width="500"> |
