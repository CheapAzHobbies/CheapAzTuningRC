...
| 🚫 ~~**Integy C31463 — Slash 4x4 / Stampede 4x4 / Rustler 4x4 diff**~~ | **Outdrive:** TBD — likely 5mm<br>**Housing:** TBD (likely aluminum)<br>**Internals:** N/A<br>**Part:** C31463<br>**Fits:** Slash 4x4 pattern<br>**Price:** **$18.49** (sale from $24.99) — in stock | Pro: Cheapest aftermarket option here, in stock<br><br>Con: Outdrive likely 5mm — same incompatibility with E-Revo CVD cups. Material TBD — if aluminum housing, same problem as GPM (augers out faster, holds fluid worse than plastic). At $18.49 it's still more expensive than the E-Revo assembled diff at Jenny's RC ($14.97) | <img src="src/drivetrain_integy_diff_c31463.jpg" width="500"> |
| 🚫 ~~Traxxas Jato 4x4 / Slash 4x4 stock diffs~~ | **Outdrive:** **5mm**<br>**Housing:** Plastic<br>**Internals:** TRA6882 gear set (same as XO-1); ring gear TRA6879<br>**Part:** TBD for Slash variant<br>**Fits:** Native Jato 4x4 / Slash 4x4<br>**Price:** ~$12.97 assembled (Jato 4x4, Jenny's RC, 5 in stock) | Pro: Native fit. Jato 4x4 version is the cheapest assembled diff here. Same TRA6882 gear set as XO-1<br><br>Con: **5mm outdrives — physically can't mate the in-hand E-Revo CVDs or axles.** The only thing stopping this from being the pick | <img src="src/drivetrain_traxxas_jato_4x4_stock_diff.jpg" width="500"> |
...
|---|---|---|---|
| ⭐ **TRA6814 — Traxxas Pre-Built Center Diff Kit** | **Part:** TRA6814 (rebuild: TRA6884 housing + TRA6883 gear set)<br>**Housing:** Plastic<br>**Spur:** N/A (separate spur)<br>**Oil:** Tunable via silicone oil (sealed, pre-filled)<br>**Weight:** N/A<br>**Fits:** Slash 4x4, Jato 4x4<br>**Price:** **$39.95** complete (~$20 built from TRA6884 + TRA6883) | Pro: Pre-built and pre-filled — installs in minutes. Sealed and tunable. **Cheaper to build from components than buy prebuilt** — TRA6884 ($5: housing, X-ring gaskets, ring gear gaskets/bushings, hardware) + TRA6883 ($15: output gears x2, spider gears x2, spider gear shaft) = ~$20 vs $39.95 for TRA6814. $5 housing rebuild when worn<br><br>Con: $39.95 for the complete kit if not building from parts | <img src="src/drivetrain_traxxas_center_diff_tra6814.jpg" width="500"><br><img src="src/drivetrain_traxxas_center_diff_housing_tra6884.jpg" width="500">&nbsp;<img src="src/drivetrain_traxxas_center_diff_gear_set_tra6883.jpg" width="500"><br><em>TRA6814 complete · TRA6884 housing · TRA6883 gear set</em> |
| 🟢 **AliExpress Heavy Duty Centre Diff (alum body + steel 54T spur)** | **Part:** Tolex (generic)<br>**Housing:** aluminum<br>**Spur:** steel 54T (integrated)<br>**Oil:** N/A (fully assembled)<br>**Weight:** **74.6 g** (measured, incl. steel 54T spur + assembled output shaft)<br>**Fits:** Slash 4x4 / Hoss 4x4 VXL<br>**Price:** **~$15–20** ($15.23 sale / $23.43 list) | Pro: **Fully assembled for ~$20** — a cheap knock-off of the $69.95 TRA6780. If you want a complete drop-in for the price of the TRA6814 build, this is it<br><br>Con: **Heavier — 74.6 g measured vs the chosen TRA6814 OEM plastic.** The alum body + steel spur add real rotational mass right in the driveline. Aluminum housing also augers out faster than plastic. Fine as a cheap backup, but the OEM plastic is the better pick on weight grounds alone | <img src="src/drivetrain_aliexpress_center_diff_alum_steel.jpg" width="500"> |
