...
- **47.5wt rear is the sweet spot, not just a data point.** Go heavier and the car starts to bounce (rear too stiff, kicks back instead of absorbing). Go lighter and it **donkey-kicks** (rear end kicks up under braking/bumps, too soft to control the motion). 47.5wt is bracketed by both failure modes on either side
