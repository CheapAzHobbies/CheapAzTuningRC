...
| **Wltoys A929 shocks** — **A929-14** (Apache C1 knock-off) | Plastic | **Chosen — budget equal** | Pro: **Knock-off of the Apache C1 — the same 97mm big-bore plastic shock for ~$15.99/set**, white springs included. Parts interchange with the C1 / D8 / B8. Cheapest way into the chosen shock<br><br>Con: **Ships from China — slow delivery.** Knock-off QC on paper; off-brand | <img src="src/suspension_wltoys_a929_shocks_a929-14.jpg" width="500"> |
