...
| **Losi 8IGHT shocks** — **LOSA5417** (set of 4, 8B/8T) | Aluminum big bore | Candidate | Pro: 1/8-class big-bore option, community-confirmed on Slash 4x4 (RCU). **Two ways to fit:** (1) run the **full LOSA5417 set with the original Slash 4x4 tower** — the front shocks are slightly shorter, so they need that tower; or (2) **buy two rear shocks and run rears front + back with the Jato towers** (rear tower height is the same across all rear-tower variants)<br><br>Con: **LOSA5417 is unobtanium right now** — discontinued / very hard to find. Pricey; metal-body weight | <img src="src/suspension_losi_8ight_shocks_losa5417.jpg" width="500"> |
