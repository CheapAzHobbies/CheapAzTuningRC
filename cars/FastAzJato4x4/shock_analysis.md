...
>
> **Fallback if you can't find big bores: the stock Jato 4x4 GTR XX-Long shocks (13mm bore) are just fine.** They come on the car and run the setup well. **Jenny's RC sells them used as factory-assembled sets of 4, way cheaper than the D8s:** the **gray composite (plastic) 7462-GRAY** off the Jato 4x4 BL-2S (Traxxas 90154-4) is the cheap, sensible pick, and the **aluminum 7462-ORNG orange / blue** off the Jato 4x4 VXL (90386-4) is the pricier metal version. The C1/D8 big bores are the upgrade for more plush, but if a big-bore set doesn't turn up, run the GTRs and don't sweat it.
