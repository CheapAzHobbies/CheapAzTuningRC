...
|---|---|---|---|
| ⭐ **HPI Racing Apache C1** — 97mm big bore — *most likely config (front + rear); on K939* | Body: **plastic**<br><br>Bore: **16mm**<br><br>Length: 97mm<br><br>Part: **#107365** (MPN H107365)<br><br>Price: **~$20–30/pair** | Pro: Light, threaded, rebuildable, well-tuned out of the box, **same internal design as the Hot Bodies D8**. Apache C1 = HPI's plastic version of the D8 shock<br><br>Con: Plastic body cracks under hard impacts (rocks, rollovers, rear-end hits) | <img src="src/suspension_hpi_shocks_apache_c1_107365.jpg" width="500"> |
| ⭐ **Wltoys A929** (Apache C1 knock-off) — *budget equal* | Body: **plastic**<br><br>Bore: 16mm<br><br>Part: **A929-14**<br><br>Price: **~$15.99/set** (white springs incl.) | Pro: **Knock-off of the Apache C1 — the same 97mm big-bore plastic shock for a fraction of the price.** Parts interchange with the C1 / D8 / B8. Cheapest way into the chosen shock<br><br>Con: **Ships from China — slow delivery.** Knock-off QC on paper. **Horror story: some ship with the shock caps super-glued shut** — soak in **acetone** to free them for rebuilds. **Would happily run these, but availability is unproven** — no order placed yet | <img src="src/suspension_wltoys_a929_shocks_a929-14.jpg" width="500"> |
| 🟢 **Hot Bodies B8 shock set** — *scored used* | Body: **aluminum** (metal)<br><br>Bore: 16mm big bore<br><br>Set of **4** (white springs)<br><br>Price: **$65.99 used** | Pro: **The metal big-bore set the user actually wanted** — scored used as a set of 4. Metal body shrugs off impacts; same 16mm big-bore class as the Apache C1. **Hard to find** — only the plastic Apache C1 is comparable<br><br>Con: Used-market only / scarce; heavier than the plastic C1 (which is why the C1 is still the most-likely running config) | <img src="src/suspension_hb_b8_shocks.jpg" width="500"> |
| 🥈 **Hot Bodies D8** (metal body) — *metal (buy-new equivalent of the in-hand B8)* | Body: **aluminum** (metal)<br><br>Bore: 16mm<br><br>Part: **HBS67296**<br><br>Incl. piston set (1.3 / 1.4 / 1.5mm)<br><br>Price: $57.99 new (disc.) / $30–80 used | Pro: **Same design + internals as the Apache C1** but metal-bodied — survives impacts that crack the plastic version. Same 97mm big-bore shock sold as the Apache C1 and the Wltoys knock-off<br><br>Con: 15–20g heavier per shock (aluminum body adds mass at the corners). **Discontinued new** — buy when you spot one | <img src="src/suspension_hb_d8_shocks_hbs67296.jpg" width="500"> |
| 🔵 **Losi 8IGHT shocks** (8B/8T) | Body: aluminum<br><br>Bore: big bore<br><br>Part: **LOSA5417** (set of 4)<br><br>Price: pricey — **unobtanium** | Pro: 1/8-class big-bore option, community-confirmed on Slash 4x4 (RCU). **Two ways to fit:** (1) full LOSA5417 set with the **original Slash 4x4 tower** (the fronts are slightly shorter), or (2) **buy two rears and run rears front + back with the Jato towers** (rear tower height is the same across all rear-tower variants)<br><br>Con: **LOSA5417 is unobtanium right now** — discontinued / very hard to find. Pricey; metal-body weight | <img src="src/suspension_losi_8ight_shocks_losa5417.jpg" width="500"> |
| 🔵 **Traxxas GTR shocks** — XX-Long, aluminum PTFE — *(stock OEM option)* | Body: aluminum (PTFE hard-anodized)<br><br>Bore: **13mm**<br><br>Part: **7462X**<br><br>Price: **$36.95/pair** (incl. 30wt oil)<br><br>Variants: **7462 / 7462G** anodized alum · **7462-GRAY** composite (cheapest) · **7461** = shorter "Long" | Pro: **Come stock on the higher Slash 4x4 trims (Ultimate / Platinum).** Hard-anodized aluminum, PTFE bores, TiN shafts (no stiction), threaded collars, X-rings. Native Traxxas fit, **in production** (unlike the discontinued D8)<br><br>Con: **13mm bore vs the C1/D8's 16mm** — holds less oil, so the **C1/D8 are significantly more plush and consistent**. Heavier than the plastic C1; springs sold separately | <img src="src/suspension_traxxas_gtr_shocks_xxl_7462x.jpg" width="500"> |
| ❌ ~~**Traxxas Big Bore XX-Long**~~ | Body: aluminum (PTFE hard-anodized)<br><br>Bore: **10mm**<br><br>Part: **2662**<br><br>Price: $26.95/pair | Pro: Classic shock — aluminum PTFE body, TiN shafts, native Traxxas fit, cheap<br><br>Con: **Waste of money.** Was "big bore" back in the day, but **10mm is not big bore by modern standards** — smaller than the GTR (13mm) and well under the C1/D8 (16mm). For similar money the Apache C1 is far more plush | <img src="src/suspension_traxxas_big_bore_xxl_2662.jpg" width="500"> |
