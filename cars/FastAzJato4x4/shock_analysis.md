...
| 🟢 **Hot Bodies B8 shock set** — *scored used* | Body: **aluminum** (metal)<br><br>Bore: 16mm big bore<br><br>Set of **4** (white springs)<br><br>Price: **$65.99 used** | Pro: **The metal big-bore set I actually wanted** — scored used as a set of 4. Metal body shrugs off impacts; same 16mm big-bore class as the Apache C1. **Hard to find** — only the plastic Apache C1 is comparable<br><br>Con: Used-market only / scarce; heavier than the plastic C1 (which is why the C1 is still the most-likely running config) | <img src="src/suspension_hb_b8_shocks.jpg" width="500"> |
