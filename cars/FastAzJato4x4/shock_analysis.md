...
|---|---|---|---|
| ⭐ **HPI Racing Apache C1** — 97mm big bore — *most likely config (front + rear); on K939* | **Type:** Big bore<br><br>**Bore:** 16mm<br><br>**Length:** 97mm<br><br>**Body material:** Plastic<br><br>**Piston:** N/A<br><br>**Mounting:** N/A<br><br>**Part:** #107365 (MPN H107365)<br><br>**Spring:** N/A<br><br>**Oil:** N/A<br><br>**Price:** ~$20–30/pair | Pro: Light, threaded, rebuildable, well-tuned out of the box, **same internal design as the Hot Bodies D8**. Apache C1 = HPI's plastic version of the D8 shock<br><br>Con: Plastic body cracks under hard impacts (rocks, rollovers, rear-end hits) | <img src="src/suspension_hpi_shocks_apache_c1_107365.jpg" width="500"> |
| ⭐ **Wltoys A929** (Apache C1 knock-off) — *budget equal* | **Type:** Big bore<br><br>**Bore:** 16mm<br><br>**Length:** 97mm<br><br>**Body material:** Plastic<br><br>**Piston:** N/A<br><br>**Mounting:** N/A<br><br>**Part:** A929-14<br><br>**Spring:** White springs incl.<br><br>**Oil:** N/A<br><br>**Price:** ~$15.99/set | Pro: **Knock-off of the Apache C1 — the same 97mm big-bore plastic shock for a fraction of the price.** Parts interchange with the C1 / D8 / B8. Cheapest way into the chosen shock<br><br>Con: **Ships from China — slow delivery.** Knock-off QC on paper. **Horror story: some ship with the shock caps super-glued shut** — soak in **acetone** to free them for rebuilds. **Would happily run these, but availability is unproven** — no order placed yet | <img src="src/suspension_wltoys_a929_shocks_a929-14.jpg" width="500"> |
| 🟢 **Hot Bodies B8 shock set** — *scored used* | **Type:** Big bore (set of 4)<br><br>**Bore:** 16mm<br><br>**Length:** 97mm<br><br>**Body material:** Aluminum (metal)<br><br>**Piston:** N/A<br><br>**Mounting:** N/A<br><br>**Part:** N/A<br><br>**Spring:** White springs<br><br>**Oil:** N/A<br><br>**Price:** $65.99 used | Pro: **The metal big-bore set I actually wanted** — scored used as a set of 4. Metal body shrugs off impacts; same 16mm big-bore class as the Apache C1. **Hard to find** — only the plastic Apache C1 is comparable<br><br>Con: Used-market only / scarce; heavier than the plastic C1 (which is why the C1 is still the most-likely running config) | <img src="src/suspension_hb_b8_shocks.jpg" width="500"> |
| 🥈 **Hot Bodies D8** (metal body) — *metal (buy-new equivalent of the in-hand B8)* | **Type:** Big bore<br><br>**Bore:** 16mm<br><br>**Length:** 97mm<br><br>**Body material:** Aluminum (metal)<br><br>**Piston:** N/A<br><br>**Mounting:** N/A<br><br>**Part:** HBS67296<br><br>**Spring:** N/A<br><br>**Oil:** N/A<br><br>**Price:** $57.99 new (disc.) / $30–80 used | Pro: **Same design + internals as the Apache C1** but metal-bodied — survives impacts that crack the plastic version. Same 97mm big-bore shock sold as the Apache C1 and the Wltoys knock-off. Incl. piston set (1.3 / 1.4 / 1.5mm)<br><br>Con: 15–20g heavier per shock (aluminum body adds mass at the corners). **Discontinued new** — buy when you spot one | <img src="src/suspension_hb_d8_shocks_hbs67296.jpg" width="500"> |
