...
| **Wltoys A929 shocks** — **A929-14** (Apache C1 knock-off) | Plastic | **Chosen — budget equal** | Pro: **Knock-off of the Apache C1 — the same 97mm big-bore plastic shock for ~$15.99/set**, white springs included. Parts interchange with the C1 / D8 / B8. Cheapest way into the chosen shock<br><br>Con: **Ships from China — slow delivery.** Knock-off QC on paper; off-brand. **Horror story: some ship with the shock caps super-glued shut** — soak in **acetone** to free them for rebuilds. **Would happily run these, but availability is unproven** — no order placed from this source yet | <img src="src/suspension_wltoys_a929_shocks_a929-14.jpg" width="500"> |
...
| **Losi 8IGHT front shocks** (run front + rear) — **LOSA5417** | Aluminum big bore | Candidate | Pro: **Fit front and rear on this build using the Jato front towers** — another 1/8-class big-bore option alongside the HB/Apache family. **Front + rear set of 4** (8B/8T). Community-confirmed running on Slash 4x4 builds (RCU)<br><br>Con: Pricey; verify exact length vs the 97mm class. Metal-body weight like the other aluminum shocks | <img src="https://placehold.co/300x200/eee/333?text=IMAGE+NEEDED" width="500"><br>🚧 save as `src/suspension_losi_8ight_shocks_losa5417.jpg` |
