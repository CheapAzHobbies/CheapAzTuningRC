...
| 🔵 **Traxxas GTR XX-Long, aluminum** — *stock Jato 4x4 VXL shock (7462-ORNG / blue); metal, pricier* | **Type:** XX-Long<br><br>**Bore:** 13mm<br><br>**Length:** N/A<br><br>**Body material:** **Aluminum (hard-anodized)**<br><br>**Piston:** N/A<br><br>**Mounting:** N/A<br><br>**Part:** **7462-ORNG** orange / blue (off Traxxas 90386-4)<br><br>**Spring:** Incl. 7443 (0.762) + 7449 (1.004)<br><br>**Oil:** 30wt incl.<br><br>**Price:** used **set of 4** at Jenny's RC, pricier than the gray composite | Pro: Metal-body version of the same stock GTR, PTFE bores, TiN shafts (no stiction), threaded collars. Also on the higher Slash 4x4 trims. In production, unlike the discontinued D8<br><br>Con: **Pricier than the gray composite for no real gain here**, since I'd run plastic anyway and already have the metal D8s for the metal-body build. Same 13mm bore as the gray, so no plushness edge over it | <img src="src/suspension_traxxas_gtr_shocks_xxl_orange_7462-orng.jpg" width="250">&nbsp;<img src="src/suspension_traxxas_gtr_shocks_xxl_blue.jpg" width="250"><br><em>orange · blue (same alloy shock)</em> |
