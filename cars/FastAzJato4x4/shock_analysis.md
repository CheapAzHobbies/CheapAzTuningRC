...
|---|---|---|---|
| **Front** | **White 59gf** (Hot Bodies #67454, 76mm, stock Apache C1 / D8) | **1.4mm × 6 holes** | **40wt** (Traxxas TRA5033, 500 cSt) ✅ retested, runs better than 45wt |
| **Rear** | **Grey 52gf** (Hot Bodies #67453, 76mm, soft for bump compliance) | **1.4mm × 6 holes** | **47.5wt** (Associated ASC5438, 613 cSt) ✅ runs better than 60wt |

<p align="center"><img src="src/suspension_traxxas_shock_oil_40wt_tra5033.jpg" width="300">&nbsp;<img src="src/suspension_associated_shock_fluid_47-5wt_asc5438.jpg" width="300"><br><em>Front: Traxxas 40wt (TRA5033), 500 cSt, $6.95 · Rear: Associated Factory Team 47.5wt (ASC5438), 613 cSt, $7.99. Both from Tammies Hobbies</em></p>
...
- **Retested: 40wt front / 47.5wt rear runs better** than the earlier 45wt front / 60wt rear call. That earlier note reasoned 60wt rear because 50wt "felt too floaty". A later retest reversed that; the rear now runs **Associated 47.5wt**, paired with a lighter 40wt front (down from 45wt). Rear still the heavier of the two, controlling squat under power and rebound from jumps
- **47.5wt rear is the sweet spot, not just a data point.** Go heavier and the car starts to bounce (rear too stiff, kicks back instead of absorbing). Go lighter and it **donkey-kicks** (rear end kicks up under braking/bumps, too soft to control the motion). 47.5wt is bracketed by both failure modes on either side. **47.5wt is the official rear number; 50wt works if 47.5 can't be found**
