...
<p align="center">
  <img src="src/aero_redspider_wheels.jpg" width="400">&nbsp;<img src="src/aero_redspider_wheels_r305_white.jpg" width="400"><br>
...
| 🔵 **Pro-Line Hole Shot 2.0, 1/8 buggy 17mm (PRO9041-233)** — *used to run, same as RedSpider* | **Part:** **PRO9041-233** (Hole Shot 2.0, 1/8, 17mm, S3, Lightweight Velocity wheel)<br>**Type:** 1/8 buggy pre-mount<br>**Tread:** Hole Shot mini-pin (small square lug)<br>**Compound:** S3<br>**Dia:** 4.33" / 110mm<br>**Width:** 1.68" / 43mm<br>**Rim:** white Lightweight Velocity dish, 17mm hex<br>**Hex:** 17mm<br>**Weight:** light wheel (~35.6g/set lighter than 2702 V2)<br>**Foam:** reusable closed-cell included<br>**Pre-glued:** pre-mounted<br>**Price:** **$31.99 / pair** (~$63.98 / set of 4) | Pro: **Same performance as the RedSpider** (both are mini-pin race treads, comparable grip). Iconic hard-pack/dusty race tread, lightweight wheel, USA-made, reusable closed-cell foam<br><br>Con: Pricier than the RedSpider for the same result. Non-belted (rips at high RPM) | <img src="src/aero_proline_holeshot2_premount_pro9041.jpg" width="250"> |
