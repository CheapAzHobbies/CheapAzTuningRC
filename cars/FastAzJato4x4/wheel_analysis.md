...
|---|---|---|---|
| ⭐ **RED SPIDER R235 / R305** (mounted) — *same tire, colored rims* | **Part:** **R235 / R305** (R305 = white version)<br>**Type:** 1/8 off-road buggy<br>**Tread:** mini-pin / block<br>**Compound:** soft rubber (unmarked)<br>**Dia:** **118mm** (OD)<br>**Width:** N/A<br>**Rim:** RED SPIDER colored dish rims (17mm hex)<br>**Hex:** 17mm<br>**Weight:** N/A<br>**Foam:** included<br>**Pre-glued:** mounted set<br>**Price:** N/A (from RED SPIDER Store) | Pro: **Takes a few laps to wear in, then hooks really well.** **Wears slowly and keeps gripping for a long time**, the standout trait, and the **most durable of the sets I have**. Fits 1/8 buggies (Kyosho MP10 / Traxxas Jato / HSP / VRX). Cheap, colored rims are a free cosmetic pick<br><br>Con: **Not at full grip when fresh**, give them a few laps. Weight + paid price still to log | <img src="src/aero_redspider_wheels.jpg" width="200">&nbsp;<img src="src/aero_redspider_wheels_r305_white.jpg" width="130"><br><em>R235 · R305 (white)</em> |
...
- **Still to log:** width, weight, and the paid price for the RedSpider set (parts **R235 / R305** (R305 = white), 118mm OD confirmed).
