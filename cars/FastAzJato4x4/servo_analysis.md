...
| Servo | Photo | Weight |
|-------|-------|--------|
| **PTK 9752TG-D** | <img src="src/steering_ptk_9752tgd_servo_weight.jpg" width="280"> | **60.2 g** (matches spec) |
| JX CLS6336HV | 🚧 save as `src/steering_jx_cls6336hv_servo_weight.jpg` | 63 g (per spec, scale shot TBD) |
