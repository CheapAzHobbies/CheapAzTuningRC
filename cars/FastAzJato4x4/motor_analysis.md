...
| **Tekin Pro4 HD 2500KV** (#TEKTT2521) | KV: **2500**<br>Can: **35.8mm × 62.5mm** (under both size Musts)<br>Weight: **221g** (lightest 4S-native option in this comparison)<br>**Shaft: 5mm × 15.3mm**<br>Cells: **2-4S (2500KV is the 4S variant of the Pro4 HD line)**<br>Sensored: Yes (dual-plug sensor harness, JST-ZH compatible)<br>Bearings documented: front 5×14×5mm / rear 5×11×5mm<br>Max RPM: 65,000<br>Max temp: 180°F (82°C)<br>Price: ~$140-160 | **Candidate** | Pro: **Lightest 4S-native motor in the entire comparison at 221g** (44g lighter than Castle 1412, 97g lighter than 1415). 4-pole 550 design, 5mm shaft, CNC 6061 T6 aluminum heatsink can, sintered neodymium magnets, dual-plug sensor harness works with anything, US-designed by Tekin, rebuildable, documented bearings<br>Con: 65k max RPM lower than Castle's 75k (smaller speed-run ceiling), 2500KV is on the lower end of pipey | <img src="https://placehold.co/300x200/eee/333?text=IMAGE+NEEDED" width="300"><br>🚧 save as `src/electronics_tekin_pro4_hd_2500kv.jpg` |
