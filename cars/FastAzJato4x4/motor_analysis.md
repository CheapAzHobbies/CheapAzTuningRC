...
>
> ⚠️ **The detailed analysis below (Tekin Pro4 HD vs. alternatives) is pre-combo research, kept for reference**, it no longer reflects the current pick. The chosen **EZRun 3665SD G3 2400KV** is the ⭐ top row of the [comparison table](#motor-comparison).
