...
| **Castle Creations 1412 3200KV — 5mm shaft** (#060-0096-00) | Same as 1412 3200KV above but with **5mm output shaft** for 5mm-bore pinions<br>Price: **$129.95** (list $159) | **Candidate** | Pro: All the 1412 3200KV traits + thicker 5mm shaft for high-torque pinion compatibility<br>Con: Same heat problem as the 1/8" variant; $10 premium over the 1/8" version | <img src="src/electronics_castle_1412_3200kv.jpg" width="300"><br><em>shared photo — same motor as 1412 3200KV, different shaft</em> |
| **Castle Creations 1412 2100KV** (#060-0094-00, 1/8" shaft) | KV: **2100**<br>Same 36mm × 62.5mm can as 3200KV variant<br>Weight: ~265g<br>Cells: 2-4S<br>Sensored: Yes<br>Price: $119.95 (list $146.80) | **Vetoed** | Pro: Lower KV runs cooler on 4S; same physical motor as the 1412 3200KV<br>Con: **2100KV is just below the 2200-3200KV Must range** — only 100KV under, but technically out of band. Would work and run cool but is below the target performance envelope for this build | <img src="src/electronics_castle_1412_3200kv.jpg" width="300"><br><em>shared photo — same 1412 can, different windings</em> |
| **Castle Creations 1412 2100KV — 5mm shaft** (#060-0095-00) | Same as 1412 2100KV above with **5mm output shaft**<br>Price: $124.95 (list $152.90) | **Vetoed** | Pro: Adds 5mm shaft option to the cool-running low-KV 1412 variant<br>Con: Same KV-below-Must issue as the 1/8" 2100KV | <img src="src/electronics_castle_1412_3200kv.jpg" width="300"><br><em>shared photo — same 1412 can</em> |
