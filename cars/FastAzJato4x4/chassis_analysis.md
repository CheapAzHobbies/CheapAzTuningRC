...
| ~~Traxxas OEM HCG chassis (6822)~~ | Composite nylon<br>HCG (High Center of Gravity) | **Vetoed** | Pro: Free (in box with Jato 4x4), tough in crashes, can be lighter than CF<br><br>Con: **High center of gravity** — the main reason this gets replaced. The CF kit is LCG and comes as a complete package with aluminum bulkheads + mounts | <img src="src/chassis_traxxas_oem_hcg_6822.jpg" width="500"> |
