...
|---|---|---|---|---|
| **AliExpress CF LCG Chassis Kit** (fits TRA6808 / 6087 / 6804 Slash 4x4 VXL) | Material: Carbon fiber + aluminum alloy<br>Type: LCG (Low Center of Gravity)<br>Motor fit: VXL-3s, 550 type, Castle 1515 Mamba Monster + similar<br>Tested: large pinion gear-up to 125 MPH | **Chosen** | Pro: **~$100 or less**. Direct fit to the Slash 4x4 / Jato 4x4 chassis pattern. CF + aluminum alloy construction. LCG lowers center of gravity vs stock. Compatible with Castle 1515 already in this build. Easy to replace if needed<br><br>Con: QC varies between sellers; no warranty. **Weight vs OEM unconfirmed** — CF + aluminum alloy construction may not actually be lighter than the OEM plastic chassis. Build also requires a PowerHobby aluminum front bulkhead (plastic front bulkheads break) which is a significant aluminum chunk — actual build weight needs a weigh-in to verify | <img src="src/chassis_aliexpress_cf_slash_4x4.png" width="500"> |
...
- **Aluminum front bulkhead required:** plastic front bulkheads break under hard hits, so the prototype uses a PowerHobby aluminum front bulkhead. That's a significant aluminum chunk that offsets some of the weight benefit of the CF chassis — actual weight vs OEM is unconfirmed and needs a weigh-in.
