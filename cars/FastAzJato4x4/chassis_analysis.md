...
| ~~Traxxas OEM LCG chassis (TRA7422)~~ | Composite nylon<br>LCG (Low Center of Gravity) | **Vetoed** | Pro: LCG, tough in crashes, can be lighter than CF. Better starting point than HCG<br><br>Con: Doesn't come with the aluminum bulkheads, motor mount, and hardware that the CF kit includes — would need separate purchases to match the complete CF kit package | <img src="src/chassis_traxxas_oem_lcg_tra7422.jpg" width="500"> |
