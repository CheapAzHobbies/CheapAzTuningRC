...
| Part | Spec | Status | Pros / Cons | Photo / Link |
|---|---|---|---|---|
| ~~**Aluminum Rear Bumper Mount — Rustler 4×4 (6823/6737 compatible)**~~ | Material: Aluminum<br><br>Seller: crazyracer (eBay)<br><br>Price: $7.99 + $9.00 shipping (~$17 total) | Vetoed | Pro: Stiffer than plastic, won't sand down<br><br>Con: **Unnecessary weight, and misses the point.** The front plastic bumper always wears first — ground contact sands it down faster than the rear. Since bumpers come as a front+rear pair, when the front wears out you buy a new set anyway and get a fresh rear for free. Upgrading just the rear to aluminum adds weight without solving anything. Would only make sense if the front bumper was sold individually | <img src="src/bumpers_crazyracer_alum_rear_mount_6737.jpg" width="500"> |
| ~~**TRA6737X — Rustler 4×4 Rear LED Bumper + Support (replacement)**~~ | Material: glass-filled nylon<br><br>Native fit: Rustler 4×4 (fits 6795 LED Light Kit)<br><br>Price: **$10.00** | Vetoed | Pro: Has a bottom skid plate component that could theoretically be used on its own<br><br>Con: Why spend money on this when Jato 4x4 front+rear bumpers come as a cheap pair — just buy the native set | <img src="src/bumpers_traxxas_rustler_4x4_rear_led_support_6737x.jpg" width="500"> |
| ~~**TRA6836 — Traxxas Slash 4x4 rear bumper + mount**~~ | Material: glass-filled nylon<br><br>Native fit: Slash 4x4 chassis pattern<br><br>Price: ~$8 | Vetoed | Pro: Bigger / sturdier than TRA9044 rear piece<br><br>Con: Too large, interferes with wheel/wing mounts | <img src="src/bumpers_traxxas_slash_4x4_rear_tra6836.jpg" width="500"> |
| ~~**RPM 80122 — Slash 4x4 Rear Bumper**~~ | Material: RPM reinforced composite<br><br>Native fit: Slash 4x4 (LCG + non-LCG)<br><br>Price: ~$12-15 | Vetoed | Pro: RPM bulletproof composite<br><br>Con: Too large, interferes with wheel/wing mounts. Wrong platform on top of it | <img src="src/bumpers_rpm_80122_slash_4x4_rear.jpg" width="500"> |
