...
| ~~TRA6835 — Slash 4x4 front bumper~~ | Material: glass-filled nylon<br>Fits: Slash 4x4 chassis pattern<br>Price: ~$8 | Vetoed (for this build) | Pro: **Best impact protection of any bumper here** — large profile actually absorbs hits and keeps the front end intact. **Great offensive tool** if you're racing wheel-to-wheel — the broad face is perfect for nudging another car off-balance and flipping them. **Good for beginners** — newer drivers crash more, and the extra protection means more time driving and less time replacing broken parts<br>Con: Larger profile = **near-vertical-landing recovery is nearly impossible** — the bumper catches the ground and pivots the car end-over before you can throttle out. Wrong direction for this build's recovery-focused logic, but absolutely the right pick if your priorities are different (e.g. bash racing with lots of contact, or you're still learning to read landings) | <img src="https://placehold.co/300x200/eee/333?text=IMAGE+NEEDED" width="300"><br>🚧 Need image — save as `src/bumpers_traxxas_slash_4x4_front_tra6835.jpg` |
...
- **Sacrificial logic mostly doesn't apply here:** the "save the expensive chassis" argument for sacrificial bumpers is even softer than it looks. **The CF chassis isn't actually the first thing to break on this build** — the FLM extended arms are (see [`chassis_analysis.md`](chassis_analysis.md#notes) and [`arm_analysis.md`](arm_analysis.md)), and the arms bend back rather than shatter. So bumpers being cheap matters more than them being sacrificial in the strict shock-tower sense.
