...
| Part | Spec | Status | Pros / Cons | Photo / Link |
|---|---|---|---|---|
| ~~**Aluminum Rear Bumper Mount — Rustler 4×4 (6823/6737 compatible)**~~ | Material: Aluminum<br>Seller: crazyracer (eBay)<br>Price: $7.99 + $9.00 shipping (~$17 total) | Vetoed | Pro: Aluminum mount — stiffer and more durable than plastic<br><br>Con: **More expensive than just buying another TRA9044 set.** Jato 4x4 bumpers come as a front+rear pair cheaply — no need to track which end wears first, just swap the whole set. Aluminum bends and stays bent; plastic cracks clean and is cheap to replace | <img src="src/bumpers_crazyracer_alum_rear_mount_6737.jpg" width="500"> |
| ~~**TRA6737X — Rustler 4×4 Rear LED Bumper + Support (replacement)**~~ | Material: glass-filled nylon<br>Native fit: Rustler 4×4 (fits 6795 LED Light Kit)<br>Price: **$10.00** | Vetoed | Pro: Has a bottom skid plate component that could theoretically be used on its own<br><br>Con: Too large, interferes with wheel/wing mounts. Not worth the cost — go straight for Jato 4x4 native rear bumpers instead | <img src="src/bumpers_traxxas_rustler_4x4_rear_led_support_6737x.jpg" width="500">&nbsp;<img src="src/bumpers_traxxas_rustler_4x4_rear_led_mount_6737x_alt.jpg" width="500"><br><em>product shot · mount view</em> |
| ~~**TRA6836 — Traxxas Slash 4x4 rear bumper + mount**~~ | Material: glass-filled nylon<br>Native fit: Slash 4x4 chassis pattern<br>Price: ~$8 | Vetoed | Pro: Bigger / sturdier than TRA9044 rear piece<br><br>Con: Too large, interferes with wheel/wing mounts | <img src="src/bumpers_traxxas_slash_4x4_rear_tra6836.jpg" width="500"> |
| ~~**RPM 80122 — Slash 4x4 Rear Bumper**~~ | Material: RPM reinforced composite<br>Native fit: Slash 4x4 (LCG + non-LCG)<br>Price: ~$12-15 | Vetoed | Pro: RPM bulletproof composite<br><br>Con: Too large, interferes with wheel/wing mounts. Wrong platform on top of it | <img src="src/bumpers_rpm_80122_slash_4x4_rear.jpg" width="500"> |
