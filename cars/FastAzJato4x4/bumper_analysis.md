...
| Part | Spec | Status | Pros / Cons | Photo / Link |
|---|---|---|---|---|
| ~~**Aluminum Rear Bumper Mount — Rustler 4×4 (6823/6737 compatible)**~~ | Material: Aluminum<br>Seller: crazyracer (eBay)<br>Price: $7.99 + $9.00 shipping (~$17 total) | Vetoed | Pro: Stiffer than plastic<br><br>Con: **Unnecessary weight** — rear bumper area isn't likely to bend anyway. Jato 4x4 bumpers come as a cheap front+rear pair; just swap the whole set when needed. No reason to add metal where plastic is sufficient | <img src="src/bumpers_crazyracer_alum_rear_mount_6737.jpg" width="500"> |
