...
| 🔵 **TRA6736 + TRA6737 — Rustler 4x4 BL-2s Front + Rear Bumpers** | Material: glass-filled nylon<br><br>Coverage: front (6736) + rear (6737) pair<br><br>Native fit: Rustler 4x4 BL-2s<br><br>Price: ~$5 (Jenny's RC, pulled from new) | Pro: Front+rear set, same as TRA9044 approach. Standard non-LED bumper. Pulled from new models at Jenny's RC for cheap<br><br>Con: Availability limited (sold out at time of writing — notify when available). Rustler 4x4 BL-2s specific, verify mount compatibility with CF chassis | <img src="src/bumpers_traxxas_rustler_4x4_front_rear_6736_6737.jpg" width="500"> |
