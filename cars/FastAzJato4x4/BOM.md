...
| **Closed-cell foam inserts (4pc)** — the good reusable ones, keeps it planted / less rim slap | 1 set of 4 | ✅ **In Hand** | AliExpress | **~$9.42** | [`wheel_analysis.md`](wheel_analysis.md#foam-inserts) |
...
| **Alternate wheel/tire sets: Tokyo Speed + unbranded + generic Mitsubishi-tread + triangle 26013 tires** | 4 sets of 4 | Backups; RED SPIDER is the running set. Mitsubishi-tread has nice race foam; triangle 26013 is tire-only + fragile. See [`wheel_analysis.md`](wheel_analysis.md) | $20 (Tokyo Speed) + $13.17 (unbranded) + $13 (Mitsubishi-tread) + $13.04 (triangle 26013) |
