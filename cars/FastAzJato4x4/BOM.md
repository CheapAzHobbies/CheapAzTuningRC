...
- **Output shafts:** bought 4× TRA6752 long shafts, but only the **front** needs them; the **rear reuses 2 of the knock-off set's stock-length shafts**, so **only 2 are used** and 2 are spare. The [driveshaft build sheet](driveshaft_analysis.md#2wd-long-cvds--6752-output-shafts-cheap-long-axle-build) is now the 2-front spec.
