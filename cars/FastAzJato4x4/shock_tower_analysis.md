...
| **Traxxas Slash 4x4 Extreme HD Rear Tower TRA9039** | Material: **Glass-filled nylon (Extreme HD)**<br>Thickness: **~4mm**<br>Weight: **~30-40 g** (baseline)*<br>Failure mode: **Flexes, cracks gradually (sacrificial)**<br>Price: **$6.00** (AMain) | **Chosen (rear)** | Pro: Slash 4x4 tower geometry — shocks centered and forward, protected from rear impacts. Meelobee aluminum plate on top accepts TRA9046 wing mount. $6.00, same price as Jato stock. Available in multiple colors (black, blue, orange, red, green)<br><br>Con: Requires fabricating small aluminum plate for wing mount. Designed for use with TRA9080 HD Upgrade Kit — confirm fit on Jato chassis | <img src="src/suspension_shock_tower_traxxas_slash4x4_rear_tra9039.jpg" width="500"> |
| **Traxxas Slash 4x4 Standard Rear Tower TRA6838** | Material: **Hardened plastic**<br>Dimensions: 87.5mm × 60.5mm<br>Weight: **~30-40 g** (estimated)*<br>Failure mode: **Flexes, cracks gradually (sacrificial)**<br>Price: **$6.00** (RC Superstore) | Candidate (rear alt) | Pro: Same Slash 4x4 geometry as TRA9039 but standard (non-HD) construction. Also $6.00. Older/simpler version — may be easier to source locally<br><br>Con: Less robust than TRA9039 Extreme HD. No image yet | <img src="https://placehold.co/500x300/eee/333?text=IMAGE+NEEDED" width="500"><br>🚧 save as `src/suspension_shock_tower_traxxas_slash4x4_rear_tra6838.jpg` |
