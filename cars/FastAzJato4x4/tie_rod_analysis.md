...
| 🥈 **Arrma Steel Turnbuckle M4x60 (ARA330601)** — *budget / spare alternate* | **Type:** Threaded turnbuckle<br>**Material:** Steel (tough, black)<br>**MPN:** Arrma **ARA330601**<br>**Fits:** M4x60, drops onto any M4 link (sold for Arrma Mojave etc.)<br>**Adjustable:** Yes, **5mm hex adjuster**<br>**Length:** **60mm** rod (end-to-end)<br>**Price:** **$3.00 each** ($5.99 / pair) | Pro: **Exact same M4x60 spec as the titanium for half the per-rod price** ($3 vs $5.99). Purpose-made tough steel with a 5mm adjuster flat, not a brittle stock toe link. Cheap, tough spare<br><br>Con: **Steel, so heavier than titanium and it can rust.** Fine as a backup, but titanium is the lighter, no-rust runner | <img src="src/steering_arrma_steel_turnbuckle_m4x60_ara330601.jpg" width="500"> |
...
- **M4x60 is a cross-brand standard size.** The ACER titanium and the Arrma steel (ARA330601) are both exactly M4x60, so replacements are easy to source across brands. Titanium is the runner; the Arrma steel (~$3/rod, tough purpose-made steel, not the brittle stock toe link) is the cheap backup, just heavier and can rust.
