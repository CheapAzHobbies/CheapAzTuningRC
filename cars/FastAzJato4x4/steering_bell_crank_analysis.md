...
|---|---|---|---|---|
| **Generic AliExpress aluminum servo bell crank set** | 7075-T6 / 6061 aluminum | **Leading** | Pro: ~$10 shipped, bearing-supported, same set the K939 already runs without issues. Stiff enough for a strong servo, doesn't flex measurably<br><br>Con: QC varies seller-to-seller; no brand warranty | <img src="https://placehold.co/300x200/eee/333?text=IMAGE+NEEDED" width="500"><br>🚧 save as `src/steering_aliexpress_aluminum_bell_crank.jpg` |
| **Integy aluminum bell crank** (Slash 4x4 / Jato 4x4 fit) | 7075-T6 aluminum | Candidate | Pro: Known brand, QC consistent, anodized color options, bearing-supported, full bumper-to-bumper Slash family fit<br><br>Con: $25-40 — 2.5-4× the AliExpress generic for marginal real-world improvement | <img src="https://placehold.co/300x200/eee/333?text=IMAGE+NEEDED" width="500"><br>🚧 save as `src/steering_integy_aluminum_bell_crank.jpg` |
| **GPM aluminum bell crank** (Slash 4x4 / Jato 4x4) | 7075-T6 aluminum | Candidate | Pro: Color options (orange, blue, red, black, etc.), well-machined, similar quality to Integy<br><br>Con: $25-35, same diminishing-returns story vs the AliExpress generic | <img src="https://placehold.co/300x200/eee/333?text=IMAGE+NEEDED" width="500"><br>🚧 save as `src/steering_gpm_aluminum_bell_crank.jpg` |
| **Traxxas stock plastic bell crank** | Glass-filled nylon | **Vetoed** | Pro: Free if stock car is sourced, bulletproof in crashes<br><br>Con: **Flexes under the chosen PTK 9752TG-D servo's load** — measurable on-throttle understeer because the crank is moving when the wheels should be. Servo's force is wasted bending plastic instead of turning wheels | — |
| **RPM aftermarket plastic** | Reinforced composite | Candidate | Pro: Stiffer than stock plastic, very crash-resistant, cheap ($12-18)<br><br>Con: Still plastic — under a 25+ kg-cm servo, it'll flex more than aluminum. Improvement over stock but not over the aluminum AliExpress option | — |
