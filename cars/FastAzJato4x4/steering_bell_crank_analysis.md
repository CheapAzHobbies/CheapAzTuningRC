...
|---|---|---|---|
| ⭐ **Generic AliExpress aluminum servo bell crank set** | **Material:** 7075-T6 / 6061 aluminum<br><br>**Pivots:** Ships with ball bearings — swap for Traxxas Oilite TRA3775 brass bushings<br><br>**Fits:** Slash 4x4 / Jato 4x4 (same set the K939 runs)<br><br>**Price:** ~$10 shipped | Pro: Stiff aluminum body, same set the K939 already runs without issues. Doesn't flex under a strong servo<br><br>Con: QC varies seller-to-seller; no brand warranty. The included bearings are the wrong tool for bell crank duty — plan to swap them | <img src="https://placehold.co/300x200/eee/333?text=IMAGE+NEEDED" width="500"><br>🚧 save as `src/steering_aliexpress_aluminum_bell_crank.jpg` |
| 🥈 **New Enron aluminum bell crank set** — *brand-match (Enron rockers + hubs)* | **Material:** aluminum, **20 g**; bores 8mm / 5mm / 4mm<br><br>**Pivots:** Ships with ball bearings — swap for Traxxas Oilite TRA3775 brass bushings (same as the others)<br><br>**Fits:** Slash 4x4 / Jato 4x4<br><br>**Colors:** red / blue / dark grey / silver<br><br>**Price:** TBD | Pro: **Brand-consistent with the Enron rockers + hub carriers**; well-machined aluminum, light (20 g), color options<br><br>Con: Pricier than the ~$10 generic; still ships with ball bearings — plan the TRA3775 bushing swap | <img src="src/steering_enron_aluminum_bell_crank.jpg" width="250"> <img src="src/steering_enron_aluminum_bell_crank_dims.jpg" width="250"><br><em>product · dimensions (20 g)</em> |
| 🔵 **Integy aluminum bell crank** (Slash 4x4 / Jato 4x4 fit) | **Material:** 7075-T6 aluminum<br><br>**Pivots:** Ships with ball bearings — same TRA3775 bushing swap recommended<br><br>**Fits:** Slash 4x4 / Jato 4x4 (full Slash family)<br><br>**Price:** $25-40 | Pro: Known brand, QC consistent, anodized color options, full Slash family fit<br><br>Con: 2.5-4× the AliExpress generic for marginal real-world improvement; still ships with the wrong bearings | <img src="https://placehold.co/300x200/eee/333?text=IMAGE+NEEDED" width="500"><br>🚧 save as `src/steering_integy_aluminum_bell_crank.jpg` |
| 🟢 **GPM aluminum bell crank (6845X)** — *in hand* | **Material:** 7075 aluminum, blue<br><br>**Part:** GPM **6845X** (Rustler / Hoss / Stampede / Slash 4x4 VXL)<br><br>**Pivots:** Ships with **4 ball bearings — swap them for Traxxas Oilite TRA3775 brass bushings** (5×8×2.5mm, the nice bushings already in hand)<br><br>**Fits:** Slash 4x4 / Jato 4x4<br><br>**Price:** **$19.98** (paid) | Pro: **In hand**, well-machined blue 7075, ships with 4 bearings. Cheaper than expected ($19.98)<br><br>Con: Like every alloy crank here, the included ball bearings are the wrong tool — **do the TRA3775 brass-bushing swap** | <img src="src/steering_gpm_aluminum_bell_crank_6845x.jpg" width="500"> |
| ❌ **Traxxas stock plastic bell crank** | **Material:** Glass-filled nylon<br><br>**Pivots:** Stock bushings<br><br>**Fits:** Slash 4x4 / Jato 4x4 (OEM)<br><br>**Price:** Free (stock) | Pro: Free if stock car is sourced, bulletproof in crashes<br><br>Con: **Flexes under the chosen PTK 9752TG-D servo's load** — measurable on-throttle understeer because the crank is moving when the wheels should be. Servo's force is wasted bending plastic instead of turning wheels. **Any decent modern servo wildly over-powers stock** — practically useless out of the box. There's a workaround (add a washer under the spring perch to preload the saver tighter so it slips less), but installing it is a pain. Just spend the few bucks on a generic cheap aluminum bell crank and skip the headache | <img src="https://placehold.co/500x300/eee/333?text=IMAGE+NEEDED" width="500"><br>🚧 save as `src/steering_traxxas_stock_bell_crank.jpg` |
