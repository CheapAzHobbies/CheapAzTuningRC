...
| 🔵 **Front steering block — GPM XO-1 alloy knuckle** | Material: **7075 aluminum** — alloy version of the Tekno/XO-1 front geometry<br><br>Scope: **knuckle / steering block only** (pair with a C-hub)<br><br>Colors: red / blue / orange / dark grey / silver<br><br>Bearings: **10×15×4 inner + 6×12×4 outer** (XO-1 front, part 6439)<br><br>Price: **$19.16** (was $21.06, 9% off) | Candidate (preferred over Tekno) | Pro: Alloy XO-1 knuckle — the metal version of the Tekno/XO-1 front, with color options, ~$19. **I'd rather run this than the Tekno nylon set** — same XO-1 geometry but metal, so it won't shear/break<br><br>Con: Steering block only (no C-hub); 1/7 XO-1 part — confirm full fit on the Jato front | <img src="src/suspension_gpm_xo1_alloy_front_knuckle.jpg" width="500"> |
---
