...
- **The alternative, which this car did not take:** drop a bare **10×18×5** straight in, which is what [Mike's Jato](../Jato4x4_Mike/README.md) runs, at the cost of **shaving the hubs** to make it fit. The sleeve route avoids that, and **10×15×4 is the easier bearing to source anyway**. Original note on sleeving the kit's existing **10×15×4** bearings up to the 18mm hub pocket with a turned **brass bushing (15 ID → 18 OD)**, press-fit with green Loctite. The 10mm ID already fits the Tekno stub and the kit has 4, so it reuses on-hand parts at the cost of a little press/machining work. Detail in [`bearings_reference.md`](bearings_reference.md).
