...
|---|---|---|---|---|
| ⭐ **Full set — MonsterKingz / G-Maxx 7075 alloy (front + rear)** | Material: **7075 aluminum**<br><br>Type: Front steering + C-hub & rear axle carriers (full set)<br><br>Brand: G-Maxx (eBay seller MonsterKingz)<br><br>Colors: black / red / green / blue / silver / purple<br><br>Price: **$46.80** (was $52, 10% off) — full 4-pc set<br><br>EHD style, runs on the EHD bearings | **Chosen (front + rear)** | Pro: **Alloy front survives the impacts that crack EHD plastic;** matched front + rear set + bearings in one buy; color options. **Rear gets Dremel-shaved** to cut the over-built meat, so it ends up near Tekno-slim weight<br><br>Con: Rear is over-built from the factory (hence the shave). Works on standard EHD inner bearing with chopped E-Revo axles | <img src="src/suspension_monsterkingz_alloy_uprights_jato4x4.jpg" width="500"> |
| 🔵 **Front C-hub + steering block — Lighthouse alloy (front only)** | Material: aluminum, gray<br><br>**EHD-style** — listed "for Traxxas Jato 1/8 4x4 BL-2S"<br><br>Scope: **front C-hub + steering block only**<br><br>Includes EHD bearings (6×12×4 + 12×18×4)<br><br>Price: **~$25** (front set, no rears) | Candidate (front-only alt) | Pro: **Front-only EHD alloy — buys exactly the front** with nothing wasted on rears. ~$25, owned, confirmed Jato 4x4 BL-2S fit<br><br>Con: Front only — vs the chosen MonsterKingz which is a matched front + rear set | <img src="src/suspension_lighthouse_alloy_front_chub_steering.jpg" width="500"> |
...
| 🔵 **Rear hub carrier — stock EHD plastic (TRA9050)** | Material: glass-filled nylon (EHD)<br><br>Part: **TRA9050** (rear carrier)<br><br>Color: gray/black | Candidate | Pro: Lightest and cheapest, OEM-correct, low-stress rear<br><br>Con: No camber-link tuning holes or built-in toe like the Tekno M6 | <img src="src/suspension_traxxas_ehd_carriers_oem_plastic.jpg" width="500"> |
...
| 🔵 **Front — stock EHD plastic (TRA9032 C-hub + TRA9037 steering block)** | Material: glass-filled nylon (EHD)<br><br>Parts: **TRA9032** (caster block / C-hub) + **TRA9037** (steering block)<br><br>The strongest of the original plastic types | Candidate (fallback) | Pro: Cheapest, lightest, sacrificial, OEM-correct fit<br><br>Con: **Strongest OEM plastic, but still breaks once in a while — too often for the front.** That's exactly why the front goes alloy | <img src="src/suspension_traxxas_ehd_carriers_oem_plastic.jpg" width="500"> |
