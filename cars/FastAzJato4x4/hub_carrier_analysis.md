...
> **Leaning: Traxxas Raptor R Ultimate alloy hubs (genuine EHD aluminum, full front + rear), ~$65.97.**
>
...
- **Chosen axle plan: Raptor R hubs front + rear, running Tekno M6 stubs.** Front Raptor R runs the **Tekno M6 17mm stubs** (**front fit confirmed** with the bearing); rear Raptor R runs the **Tekno 5580 (SCT410) or 5070 (EB48 buggy) stub**, same bearing setup. Keeps the genuine slim Raptor R hubs and swaps in the strong Tekno stubs.
- **Raptor R front + Tekno M6 17mm stubs: needs a 10×18×5 inner.** The EHD (Raptor R) outer bearing pocket is **bigger (18mm OD)** than the XO-1's, and the stock EHD inner is **12mm ID** (for the E-Revo axle). To fit the Tekno M6 stub, drop the inner to **10mm ID** while keeping the 18mm OD → a **10×18×5** bearing. To seat it, one of: file **0.2 to 0.5 mm** off the 17mm hexes, dremel the inner lip, or force it in and let it wear in. Filing the hexes is cleanest. This opens the M6 stub path without an unobtainium bearing.
