...
| 🔵 **Front steering block — Tekno TKR6837 (nylon, M6)** | Material: **nylon**, black<br><br>**Same as the XO-1 front, just nylon** — bearings **6×12×4 + 12×18×4** (same as EHD)<br><br>Scope: **steering blocks only** (L/R pair) — pair with a C-hub<br><br>**For M6 (6mm) driveshafts** — matches the E-Revo 6mm CVDs<br><br>Includes screws + washers<br><br>Price: **$8.79** | Candidate (plastic ideal) | Pro: **Ideally what I'd run — very strong for plastic, cheap, sacrificial.** XO-1 geometry, M6-compatible, stronger than stock plastic<br><br>Con: **Still plastic in a high-stress front — you'll break a few.** Steering block only (no C-hub) | <img src="src/suspension_tekno_tkr6837_steering_block_plastic.jpg" width="500"> |
| 🔵 **Front steering block — GPM XO-1 alloy knuckle** | Material: **7075 aluminum** — alloy version of the Tekno/XO-1 front geometry<br><br>Scope: **knuckle / steering block only** (pair with a C-hub)<br><br>Colors: red / blue / orange / dark grey / silver<br><br>Bearings: **6×12×4 inner + 12×18×4 outer** (XO-1 front = EHD sizes)<br><br>Price: **$19.16** (was $21.06, 9% off) | Candidate | Pro: Alloy XO-1 knuckle — the metal version of the Tekno/XO-1 front, with color options, ~$19<br><br>Con: Steering block only (no C-hub); 1/7 XO-1 part — confirm full fit on the Jato front | <img src="src/suspension_gpm_xo1_alloy_front_knuckle.jpg" width="500"> |
