...
- **Red now, orange when this one dies.** The **5511A red** was bought because Jenny's RC had it cheap, not because it was the look. **Orange (5511T) is the more iconic Jato 3.3**, and the [E-Revo](../ERevo_1.0/README.md) already wears red, so keeping the two trucks different colours is worth more than matching them. No reason to replace a working body over it, so this is the plan for whenever the red one gets wrecked.
