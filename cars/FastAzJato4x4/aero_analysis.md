...
| 🔵 **Traxxas Jato 4x4 — pre-painted** (Blue / Pink) | Part: **9018-BLUE** ($39.95) / **9060-PINK** ($43.95)<br><br>Fully pre-painted ProGraphix + pre-applied decals<br><br>Ready to mount, no trimming | Pro: **Pre-painted** — ProGraphix finish + decals, mounts right out of the bag, zero paint work<br><br>Con: **Expensive ($40–44).** Looks generic — stock-style body | <img src="src/body_traxxas_jato4x4_prepainted_blue_9018.jpg" width="500"> |
