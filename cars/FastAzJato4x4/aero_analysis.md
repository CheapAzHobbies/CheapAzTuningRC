...
| **Traxxas Sledge wing mount** TRA9518 | Candidate | Pro: Traxxas quality, pairs with TRA9517 wing already on the candidate list<br>Con: **Non-adjustable** — fixed wing angle. **Requires fabricating a sandwich plate** to mount to the Jato rear tower — same plate requirement as the Losi 8ight approach. Price TBD | <img src="src/aero_traxxas_sledge_wing_mount_tra9518.jpg" width="300"> | <img src="https://placehold.co/300x200/eee/333?text=IMAGE+NEEDED" width="300"><br>🚧 save as `src/aero_losi_8ight_wing_mount.jpg` |
