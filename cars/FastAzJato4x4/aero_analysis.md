...
| **HPI Vorza Flux Buggy Wing Mount** #67521 | Candidate | Pro: From the same platform as the HB D8 shocks — shared geometry with this build. Likely adjustable unlike the OEM Jato and STRC options<br>Con: Fit to Jato rear tower unconfirmed — verify mounting hole pattern before ordering. Price TBD | <img src="https://placehold.co/300x200/eee/333?text=IMAGE+NEEDED" width="300"><br>🚧 save as `src/aero_hpi_vorza_flux_wing_mount_67521.jpg` |
