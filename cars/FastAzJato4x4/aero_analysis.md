...
| 🔵 **Traxxas Jato 4x4 — ProGraphix** | Part: **9018X**<br><br>Graphics pre-painted, main body left clear (you pick + spray the main color)<br><br>Fully trimmed, decal sheet, clipless latches + hardware<br><br>Price: **$34.95** | Pro: **Middle ground — detailed graphics already done**, you just spray the base color. Pro-looking result with little effort<br><br>Con: Still needs the main color sprayed; pricier than the plain clear | <img src="https://placehold.co/500x300/eee/333?text=IMAGE+NEEDED" width="500"><br>🚧 save as `src/body_traxxas_jato4x4_prographix_9018x.jpg` |
| 🔵 **Traxxas Jato 4x4 — pre-painted** (6 colors) | **9060 series, $43.95 each:** red, orange, black, green (**9060-GRN**), blue (**9060-BLUE**), pink (**9060-PINK**)<br><br>Cheaper pre-painted blue: **9018-BLUE** ($39.95)<br><br>Fully pre-painted ProGraphix + pre-applied decals, ready to mount, no trimming | Pro: **Pre-painted** — ProGraphix finish + decals, mounts right out of the bag, zero paint work. Six colors to pick from<br><br>Con: **Expensive ($40–44).** Looks generic — stock-style body | <img src="src/body_traxxas_jato4x4_prepainted_blue_9018.jpg" width="500"> |
