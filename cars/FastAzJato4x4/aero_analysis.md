...
> **Chosen: AliExpress generic wing + OEM Jato 4x4 wing mount (TRA9046) via Meelobee technique**, best of both worlds. TRA9046 mounts to the rear tower (now the **MonsterKingz CF rear**, one of the two towers that carry it; the TRA9039 Slash tower is the fallback) using a small custom aluminum plate on top of the tower (not the side). 🚧 The shock-protection geometry that the Slash tower gave is now handled by the **3D-printed shock covers** (see [`shock_tower_analysis.md`](shock_tower_analysis.md)); verify the MonsterKingz CF rear + TRA9046 fit at build. Wing angle adjustable via 3D printed shims. Wing holes drilled with a reamer on the grid pattern. **Body: leaning JConcepts P2 (0684)**, race-proven shape, direct fit; the Traxxas OEM 9018 / 9060 family is the pre-painted fallback. Credit: [Meelobee on r/Traxxas](https://www.reddit.com/r/Traxxas/comments/1mzllk0/slash_4x4_converted_to_backslash/), specifically for the wing mount-to-tower plate method.
