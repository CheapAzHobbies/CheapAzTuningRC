...
|---|---|---|---|
| **Generic AliExpress 1/8 Buggy Tail Wing** | **Chosen** | Pro: $2.50–$4, noticeably lighter than Traxxas stock wing, nylon plastic (good tenacity), grid pattern on underside — drill holes with a reamer for clean precision cuts without cracking. Also fits E-Revo 1.0. Good sacrificial part — cheap enough to not care when it breaks<br>Con: QC varies on finish; irrelevant for a wing you're drilling anyway | <a href="https://www.aliexpress.us/item/3256807547003209.html"><img src="src/aero_generic_wing_aliexpress_1-8.jpg" width="300"></a><br><img src="src/aero_generic_wing_aliexpress_dimensions.webp" width="300"><br><em>with dimensions</em> |
| **Traxxas Jato 4x4 / Sledge wing** (#9517) + **Jato wing mounts** (#9046) | Candidate | Pro: Guaranteed fit to OEM Jato geometry, no guesswork on mount hole spacing. TRA9517 is shared between Jato 4x4 and Sledge — same wing<br>Con: Heavier than AliExpress nylon wing — generic is noticeably lighter. $13.79 (wing + mounts bundle) from Jenny's RC | <a href="https://www.traxxas.com/products/parts/9517"><img src="src/aero_traxxas_jato_4x4_stock_wing_90154.jpg" width="300"></a> |
...
| **Team Losi 8ight Wing + Mount** | Candidate | Pro: Mounts by sandwiching a custom plate between the wing mount and the stock rear tower — clean install, no dedicated wing mount bracket needed. Looks clean<br>Con: **Non-adjustable** — fixed wing angle. Requires fabricating a sandwich plate. Part number TBD. Price TBD | <img src="https://placehold.co/300x200/eee/333?text=IMAGE+NEEDED" width="300"><br>🚧 save as `src/aero_losi_8ight_wing_mount.jpg` |
| **Traxxas Sledge wing mount** TRA9518 | Candidate | Pro: Traxxas quality, pairs with TRA9517 wing already on the candidate list<br>Con: **Non-adjustable** — fixed wing angle. **Requires fabricating a sandwich plate** to mount to the Jato rear tower — same plate requirement as the Losi 8ight approach. Price TBD | <img src="https://placehold.co/300x200/eee/333?text=IMAGE+NEEDED" width="300"><br>🚧 save as `src/aero_traxxas_sledge_wing_mount_tra9518.jpg` | <img src="https://placehold.co/300x200/eee/333?text=IMAGE+NEEDED" width="300"><br>🚧 save as `src/aero_losi_8ight_wing_mount.jpg` |
...
|---|---|---|---|---|
| **OEM Jato 4x4 wing mount** | Stock Jato #9034 (chosen in [shock tower analysis](shock_tower_analysis.md)) | **Back side of the car** — shocks angled rearward off the tower | **Exposed to rear-end impacts** — user has cracked shock bodies (HPI Vorza 97mm) this way | <img src="src/shock_tower_traxxas_jato4x4_rear_spring_backside.jpg" width="500"> |
| ~~STRC ST6808B conversion~~ (Vetoed) | Older Slash 4x4-style rear tower | **Centered** — shocks angled forward from the tower toward the chassis | **Protected** — chassis sits between shocks and the rear bumper line | <img src="src/shock_tower_strc_slash_conversion_shock_forward.jpg" width="500"> |
