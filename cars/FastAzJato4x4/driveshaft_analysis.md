...
> **17 mm hex seat — filing required.** The 17 mm hexes have to be shaved to seat on the M6 stubs. **Ideally use the Tekno 17 mm hexes** (they come in the TKR1654-17 kit): they're **pin-through** (the cross-pin passes through the hex = more secure) and **more forgiving if you shave them thin** to fit. A friend's build used **Traxxas TRA6469 17 mm hexes** instead and **filed until the chamfer was gone** (that's the amount of material to remove) — those work, but the pin-through Tekno hexes are the better call for the thin-shave fit.
