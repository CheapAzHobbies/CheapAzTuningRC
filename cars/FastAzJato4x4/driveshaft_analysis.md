...
| **Rear** | **Tekno TKR5580**, stub for adapter TKR5570-17 / SCT410 | Rear 17mm hex setup | $16.90 | ✅ **Confirmed, fits perfectly** in the rear hubs (6 mm M6 end, 10 mm bearing seat). 🚧 **Order more TKR5580 for the FastAzJato** |
| **Rear** | **Tekno 5070**, hardened steel, EB48 (buggy) | Rear stub alt | $17.91 | **Much larger** — **8 mm stub end** (vs 6 mm on the 5580) + **~12 mm bearing seat** (vs 10 mm), so it'd need a **12 mm ID inner**, not the 10×18×5. Not the pick, 5580 is confirmed |
