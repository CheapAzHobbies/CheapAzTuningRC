...
> - **Center driveshaft: Jato 4x4 BL-2S take-off shaft (7455), $2.49 — bought instead of the TRA6855.** Native Jato fitment, bundle includes a pinion + bearings; material unconfirmed, watch for 4S deformation. TRA6855 (Slash 4x4 aluminum, 215mm) is the fallback if it doesn't hold up.
>
...
| Driveshaft | Spec | Pros / Cons | Photo / Link |
|---|---|---|---|
| ⭐ **Jato 4x4 BL-2S Center Shaft (7455)** — *bought instead, take-off part* | **Type:** One-piece, native Jato 4x4 BL-2S fitment<br>**Material:** N/A — not stated by the listing, verify plastic vs metal once in hand<br>**Part:** 7455 (bundle also includes a pinion gear + bearings, from the Traxxas 90154-4 kit)<br>**Length:** N/A<br>**Price:** **$2.49** (paid, used take-off part) | Pro: **Bought instead of the TRA6855 — dirt cheap ($2.49) genuine take-off part.** Native Jato 4x4 BL-2S fitment, so no length-mismatch risk like the Rustler/Slash mixup below. Bundle throws in a spare pinion gear + bearings<br><br>Con: **Material not confirmed** — if it turns out to be the stock composite/plastic shaft, the same 4S-deforms concern that ruled out TRA6767 below applies; verify once in hand and watch for deformation. Used take-off part, no warranty | <img src="https://placehold.co/500x300/eee/333?text=IMAGE+NEEDED" width="500"><br>🚧 save as `src/drivetrain_traxxas_jato4x4_center_shaft_7455.jpg` |
...
- **Center driveshaft pick logic:** **bought the Jato 4x4 BL-2S take-off shaft (7455, $2.49) instead of the TRA6855.** Native fitment, and the pinion + bearings bundled in made it too cheap to pass up. Material isn't confirmed from the listing — if it turns out to be plastic and deforms under 4S, fall back to the **TRA6855** (stock Slash 4x4 aluminum, 215mm). **Skip the Tekno Big Bone** — costs much more for no performance gain, still bends, chews up its outdrives, and runs noisily.
