...
- **Center driveshaft pick logic:** bashing → stock plastic ($4). Everything else → stock metal (best value). **Skip the Tekno Big Bone** — costs much more for no performance gain, still bends, chews up its outdrives, and runs noisily. Stock or even plastic is cheaper and no worse.
