...
>
> ⚠️ **WIP** — **front** length dialed: **91 mm flat** ignoring the manufacturing nub (caliper re-zeroed; the earlier 85.5 mm was a decalibrated reading). Weld the final front pair to that. **Rear axle not built yet** — tune it next, then weld both.
>
...
| **Front (adjustable prototype)** | **90.94 mm** (≈91 flat, without the manufacturing nub) | ✅ length dialed | Threaded turnbuckle-style center, adjusted to fit on the car. Re-measured with the caliper re-zeroed: **90.94 mm ignoring the manufacturing nub** (the small cast nub on the cup side) — round to **91 mm flat** for the weld target. **Shorten the stock CVD by ~46 mm** (136.60 − 91.0 = 45.6 mm; − 90.5 = 46.1 mm) — cut long, test-fit, sneak up on 90.5–91. (Earlier 85.5 mm reading was bad — caliper was decalibrated.) **Shorter = front.** |
...
- **Cut length:** **front = 91 mm flat** weld target — **shorten the stock CVD by ~46 mm** (136.60 stock − 90.5–91 target = 45.6–46.1 mm; cut long, test-fit, sneak up). Measured flat, ignoring the manufacturing nub, caliper re-zeroed. **Rear not built yet** — tune it next. See [Measured lengths](#measured-lengths-prototype). The knock-off CVD **stock cups are confirmed to fit the diffs**.
