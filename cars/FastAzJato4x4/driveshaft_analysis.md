...
> **17 mm hex seat — filing required.** The 17 mm hexes have to be shaved to seat on the M6 stubs. **Chosen: Traxxas TRA6469 17mm splined aluminum wheel hub** (6061-T6, blue-anodized, 5.9g measured, for 6mm axles) — **filed until the chamfer/bevel edge is gone** (that's the amount of material to remove). **The same shaved hub works front and rear** — front on the Tekno M6 (Slash 4x4) stub, rear on the Tekno SCT410 (TKR5580) stub. The Tekno 17mm hexes (pin-through, from the TKR1654-17 kit) are the more secure alternative if the TRA6469 fit doesn't hold up, since the cross-pin passes through the hex.
...
| **Wheel hex (front + rear)** | **Traxxas TRA6469** — 17mm splined aluminum wheel hub, 6061-T6 blue-anodized, screw pin 4×13mm w/ threadlock | Wheel-mount hex on both Tekno stubs | N/A | ✅ In hand, **5.9g measured**. Shave to the chamfer/bevel edge to seat — same modification works front and rear |

<p align="center"><img src="src/drivetrain_tekno_1654-17_front_hub_adapter.jpg" width="250">&nbsp;<img src="src/drivetrain_tekno_5580_stub_axle.jpg" width="250">&nbsp;<img src="src/drivetrain_tekno_5070_stub_axle.jpg" width="250">&nbsp;<img src="src/drivetrain_traxxas_wheel_hub_17mm_tra6469_weight.jpg" width="250"><br><em>Front: TKR1654-17 17mm M6 adapter · Rear: Tekno 5580 (TKR5570-17 / SCT410) · Tekno 5070 (EB48) · TRA6469 wheel hex, 5.9g</em></p>
