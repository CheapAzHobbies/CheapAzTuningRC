...
| 🥈 **Knock-off Slash 4x4 HD Steel CV** | **Type:** CV knock-off of TRA6851R<br>**Part:** N/A (generic)<br>**Diff end:** **5mm**<br>**Fits:** Slash 4x4 pattern (5mm cups)<br>**Price:** **~$20–30 (set of 4)** | Pro: **Runner-up to the E-Revo CVDs.** $20–30 gets a **full set of 4** — vs $69.95 for just two genuine TRA6851R axles. Same steel-CV design and smooth feel. **The Tekno M6 stub end fits these**, so you can run them with the strong M6 stubs (no cut-and-glue)<br><br>Con: **5mm diff end — switch the diff to 5mm outdrives and cups** (the rest of the build is 6mm E-Revo). Easy swap, just an extra step. **May be too short for the extended FLM arms (101.6 mm)** — stock-arm length. QC varies on paper | <img src="src/drivetrain_traxxas_slash_hd_cv_knockoff_tra6851r.jpg" width="500"> |
| 🔵 **2WD "long" CV — TRA1951R / Tekno TKR1951X (M6)** — *⚠️ fit unverified* | **Type:** CV, 2WD "long half shaft" (uses the longer 6752 half shaft)<br>**Part:** TRA1951R (Traxxas) / **TKR1951X** (Tekno M6 version)<br>**Diff end:** 5mm (2WD) — the **M6 version runs 6mm M6 stubs**<br>**Fits:** 2WD Slash / Rustler / Stampede rear<br>**Price:** **~$20–40** | Pro: **Longer than the Slash 4x4 CVD** — the candidate to reach the **extended FLM arm (101.6 mm)** length without cut-and-glue. The **TKR1951X** mates the strong **M6 stubs** (bigger bearings, captured pin)<br><br>Con: **⚠️ Fit NOT confirmed — needs checking before buying.** 2WD rear fitment (diff end differs) and **length not verified vs 90.5 mm — measure / test-fit first.** If it's still short, the SCTE **TKR2210** is longer | <img src="https://placehold.co/500x300/eee/333?text=IMAGE+NEEDED" width="500"><br>🚧 save as `src/drivetrain_traxxas_2wd_long_cv_1951r.jpg` |
...
> **Leaning axle plan (pending test fit):** **front = Tekno M6 with 17mm stubs** (Raptor R front hub, confirmed to fit with the bearing), **rear = Tekno 5580 (SCT410) or 5070 (EB48 buggy) stub**, same bearing setup. This is the direction, to be confirmed with a test fit.
...
<p align="center"><img src="src/drivetrain_jato_axle_hub_testfit.jpg" width="440"><br><em>Test-fit mockup: knock-off CVDs (10mm ends) on GPM XO-1 alloy front hub and Tekno plastic rear hub, M6 17mm stubs. The Raptor R front hub also fits with the same bearing.</em></p>
