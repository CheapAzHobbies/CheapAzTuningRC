...
| **Knock-off E-Revo 1.0 CVDs (chopped to fit)** | Type: CVD knock-off of TRA5451R<br><br>Diff end: 6mm<br><br>Price: **~$15–20 for a set of 4**<br><br>Mod: same collet / cut-to-length method<br><br>See [Knock-Off E-Revo CVDs](#knock-off-e-revo-cvds) | **Chosen — budget** | Pro: **Set of 4 for $15–20 — fantastic in real use on the E-Revo 1.0.** Indistinguishable from genuine TRA5451R in practice. Same 6mm fitment<br><br>Con: Same cut + collet work required. Knock-off QC on paper, indistinguishable in practice | <img src="src/drivetrain_knockoff_cvd_rcawd.jpg" width="500"> |
...
| **Traxxas Slash 4x4 stock axle (1st gen, U-joint)** | Type: stock Slash 4x4 U-joint half shaft<br><br>Part: **TRA6852X** (rear) / **TRA6851X** (front)<br><br>Fitment: confirm pin size vs E-Revo 6mm cups | Candidate | Pro: Cheap, widely available stock part<br><br>Con: U-joint clearance caution. Confirm 6mm fitment against the E-Revo cups before committing | <img src="src/drivetrain_traxxas_slash_stock_axle_6852x.jpg" width="500"> |
| **Traxxas Slash 4x4 HD steel CV (2nd gen)** | Type: nickel-plated steel CV w/ boots<br><br>Part: **TRA6851R** (front) / **TRA6852R** (rear)<br><br>U-joint pins held captive | Candidate | Pro: Steel CV, boots, captive pins — strong "2nd gen" upgrade, smooth like the E-Revo CVDs<br><br>Con: Confirm 6mm fitment against the E-Revo cups. Pricier than stock | <img src="src/drivetrain_traxxas_slash_hd_cv_6851r.jpg" width="500"> |
| **Traxxas Slash 4x4 EHD axles (ok)** | Type: Extreme Heavy Duty telescoping, oversized U-joints<br><br>Part: **TRA6852A** (rear) / **TRA6851A** (front)<br><br>6mm stub axles | Candidate | Pro: Beefiest Traxxas axle — telescoping, oversized U-joints, 6mm stubs. **EHD axles are ok** for this build<br><br>Con: Heaviest of the Traxxas options; overkill for casual use | <img src="src/drivetrain_traxxas_slash_ehd_6852a.jpg" width="500"> |
| **TRA9052** Rear EHD Driveshaft (9080-series) | Type: Extreme Heavy Duty rear driveshaft<br><br>Part: **TRA9052** — $14.00<br><br>Axle: **6mm**<br><br>Note: requires 9080-series upgrade kit — will not fit standard suspension parts | Candidate | Pro: **Stronger than the standard EHD axles** — same "Extreme Heavy Duty" name but genuinely beefier. $14. 6mm axle matches the E-Revo diffs<br><br>Con: Tends to break at the threads like other axles. Requires 9080-series kit — verify fitment with this build's suspension geometry | <img src="src/drivetrain_traxxas_ehd_driveshaft_tra9052.jpg" width="500"> |
