...
> **Leaning axle plan (pending test fit):** **front = Tekno M6 with 17mm stubs** (Raptor R front hub — needs the **10×18×5 inner bearing** to fit the M6 stub, *not* the stock inner), **rear = Tekno 5580 (SCT410) or 5070 (EB48 buggy) stub**. This is the direction, to be confirmed with a test fit.
...
<p align="center"><img src="src/drivetrain_jato_axle_hub_testfit.jpg" width="440"><br><em>Test-fit mockup: knock-off CVDs (10mm ends) on GPM XO-1 alloy front hub and Tekno plastic rear hub, M6 17mm stubs. The Raptor R front hub works too, but needs the 10×18×5 inner bearing (different — larger OD to clear the Tekno stub's 10mm), not the same bearing.</em></p>
