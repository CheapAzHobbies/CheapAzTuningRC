...
| **Raptor R 4x4 aluminum (custom-length)** | Material: 6061-T6 aluminum, one-piece splined<br><br>Part: **TRA10155** (Raptor R 4x4)<br><br>Length: **~247mm** — longer than the Slash's 215mm<br><br>Price: **$13.95**<br><br>Adapter: may need **TRA10122** ($27) | Candidate | Pro: **Longer shaft you cut/set to a custom length** — lets you take up the stock ~3–4mm of spline slop. Worth it on a rigid CF chassis with a top plate, where you want zero play (vs a flexy plastic chassis, where the slop is fine). 6061-T6, light, stiff<br><br>Con: Longer than needed — must measure and trim to fit. May need the Raptor chassis adapter TRA10122. Overkill if stock slop doesn't bother you | <img src="src/drivetrain_traxxas_center_driveshaft_raptor_10155.jpg" width="500"> |
