...
> **Runner-up note:** if the E-Revo CVD route falls through, the **knock-off Slash 4x4 HD steel CV ($20–30)** is the next best. Same smooth steel-CV feel for a fraction of the genuine TRA6851R price; just be ready to swap to stock Slash diff outdrives (easy) to match the 6mm cups.
...
| **Knock-off Slash 4x4 HD Steel CV** | Type: CV knock-off of TRA6851R<br><br>Diff end: 6mm<br><br>Price: **~$20–30 for a set** | **Candidate — runner-up** | Pro: **Runner-up to the E-Revo CVDs.** $20–30 — fraction of the Traxxas price for the same steel-CV design and smooth feel<br><br>Con: May need to swap to stock Slash diff outdrives — easy swap. QC varies on paper | <img src="src/drivetrain_traxxas_slash_hd_cv_knockoff_tra6851r.jpg" width="500"> |
...
- **Confirmed part numbers:** E-Revo CVD = **TRA5451R/5451X**; Slash stock U-joint axle = **TRA6852X/6851X**; Slash HD steel CV = **TRA6852R/6851R**; Slash EHD = **TRA6852A/6851A**; alum center driveshaft = **TRA6755/6855**; plastic center driveshaft = **TRA6767**; Tekno center = **TKR6855**.
- **Still TBD:** the E-Revo U-joint shaft number and the FLM part number. Also verify 6mm fitment for the Slash axles against the E-Revo cups.
