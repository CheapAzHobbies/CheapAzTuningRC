...
>
> ⚠️ **WIP** — **front** length dialed: **shorten stock CVD by exactly 46 mm → 90.6 mm** (flat, ignoring the manufacturing nub; caliper re-zeroed). Weld the final front pair to that. **Rear axle not built yet** — tune it next, then weld both.
>
...
| **Front (adjustable prototype)** | **90.94 mm** (≈91 flat, without the manufacturing nub) | ✅ length dialed | Threaded turnbuckle-style center, adjusted to fit on the car. Re-measured with the caliper re-zeroed: **90.94 mm ignoring the manufacturing nub** (the small cast nub on the cup side) — round to **91 mm flat** for the weld target. **Shorten the stock CVD by exactly 46 mm** → 136.60 − 46 = **90.6 mm** (in the 90.5–91 window). Cut a hair long and sneak up on it. (Earlier 85.5 mm reading was bad — caliper was decalibrated.) **Shorter = front.** |
...
- **Cut length:** front weld target — **shorten the stock CVD by exactly 46 mm** → 136.60 − 46 = **90.6 mm** (in the 90.5–91 window). Measured flat, ignoring the manufacturing nub, caliper re-zeroed; cut a hair long and sneak up. **Rear not built yet** — tune it next. See [Measured lengths](#measured-lengths-prototype). The knock-off CVD **stock cups are confirmed to fit the diffs**.
