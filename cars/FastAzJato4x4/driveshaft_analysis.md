...
| **MonsterKingz HD steel U-joint axles (eBay)** | Type: nickel-plated **hardened steel** U-joint / CVA, telescoping<br><br>Source: **MonsterKingz** (eBay #332244551728)<br><br>Fitment: Slash 4x4 / Stampede / Rustler / Hoss 4x4 VXL, **5mm** stub<br><br>Price: **from ~$44.99 (set of 4)** — varies by the model picked in his listing | Candidate | Pro: **This is the "FLM steel axle" I was chasing — it's actually MonsterKingz.** Hardened steel U-joints, full set of 4, telescoping. **Same axle fits all the 4x4 models** (Slash/Stampede/Rustler/Hoss) — just pick the cheapest variant in the listing. Trusted US eBay seller (99.5%, 319 sold, free fast shipping)<br><br>Con: U-joint style — watch arm / steering-link clearance at full droop like the other U-joints. 5mm Slash stub, so switch the diff to 5mm outdrives/cups | <img src="src/drivetrain_monsterkingz_hd_steel_cvd_slash4x4.jpg" width="500"> || **Knock-off Slash 4x4 HD Steel CV** | Type: CV knock-off of TRA6851R<br><br>Diff end: **5mm**<br><br>Price: **~$20–30 (set of 4)** | **Candidate — runner-up** | Pro: **Runner-up to the E-Revo CVDs.** $20–30 gets a **full set of 4** — vs $69.95 for just two genuine TRA6851R axles. Same steel-CV design and smooth feel<br><br>Con: **5mm diff end — switch the diff to 5mm outdrives and cups** (the rest of the build is 6mm E-Revo). Easy swap, just an extra step. QC varies on paper | <img src="src/drivetrain_traxxas_slash_hd_cv_knockoff_tra6851r.jpg" width="500"> |
...
| **Raptor R 4x4 aluminum (custom-length)** | Material: 6061-T6 aluminum, one-piece splined<br><br>Part: **TRA10155** (Raptor R 4x4)<br><br>Length: **~247mm** — longer than the Slash's 215mm<br><br>Price: **$13.95** | Candidate | Pro: **Longer shaft you cut/set to a custom length** — lets you take up the stock ~3–4mm of spline slop. Worth it on a rigid CF chassis with a top plate, where you want zero play (vs a flexy plastic chassis, where the slop is fine). 6061-T6, light, stiff<br><br>Con: Longer than needed — must measure and trim to fit. Overkill if stock slop doesn't bother you | <img src="src/drivetrain_traxxas_center_driveshaft_raptor_10155.jpg" width="500"> |
