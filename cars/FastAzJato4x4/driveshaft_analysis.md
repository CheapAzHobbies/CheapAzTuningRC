...
| 🟢 **Traxxas E-Revo 1.0 CVDs (chopped to fit)** — *in hand, now spares* | **Type:** CVD (constant-velocity)<br>**Part:** TRA5451R (set — sold as a set, no singles)<br>**Diff end:** **6mm**<br>**Fits:** E-Revo diffs and cups<br>**Price:** **$69.95** (Traxxas MSRP) | Pro: Smoothest power delivery through full travel — no U-joint clearance problems. The basis of the old driveline plan, cut to length and rejoined with a 6mm threaded collet / metal tube (see method below)<br><br>Con: **Wrong diff end now — the diffs went back to stock 5mm.** Falls to spares/fallback unless the diff plan moves back to E-Revo 1.0 (6mm). Genuine set is $69.95 vs the ~$20–28 knock-off | <img src="src/drivetrain_traxxas_e_revo_cvd_5451r.jpg" width="500"> |
...
| 🔵 **2WD "long" CV — TRA1951R / Tekno TKR1951X (M6)** — *⚠️ fit unverified* | **Type:** CV, 2WD "long half shaft" (uses the longer 6752 half shaft)<br>**Part:** TRA1951R (Traxxas) / **TKR1951X** (Tekno M6 version)<br>**Diff end:** 5mm (2WD) — the **M6 version runs 6mm M6 stubs**<br>**Fits:** 2WD Slash / Rustler / Stampede rear<br>**Price:** **~$20–40** | Pro: **Longer than the Slash 4x4 CVD** — the candidate to reach the **extended FLM arm (101.6 mm)** length without cut-and-glue. The **TKR1951X** mates the strong **M6 stubs** (bigger bearings, captured pin)<br><br>Con: **⚠️ Fit NOT confirmed — needs checking before buying.** 2WD rear fitment (diff end differs) and **length not verified vs 90.5 mm — measure / test-fit first.** If it's still short, the SCTE **TKR2210** is longer | <img src="src/drivetrain_traxxas_2wd_long_cv_1951r.jpg" width="500"> |
...
> **17 mm hex seat — filing required.** The 17 mm hexes have to be shaved to seat on the M6 stubs. **Leaning: the Tekno OEM 17mm hexes** (pin-through, from the TKR1654-17 kit) — the cross-pin passes through the hex for a more secure hold, and they're more forgiving if shaved thin. Not yet photographed/weighed. **Traxxas TRA6469** (17mm splined aluminum, 6061-T6 blue-anodized, 5.9g measured, for 6mm axles) is an alternative in hand — filed until the chamfer/bevel edge is gone, and the same shaved hub would work front and rear — but the Tekno OEM hex is the more likely pick.
...
| **Wheel hex (front + rear)** | **Tekno OEM 17mm hex** (pin-through, from TKR1654-17 kit) | Wheel-mount hex on both Tekno stubs | Included in TKR1654-17 | 🔵 **Leaning** — not yet photographed/weighed |
| **Wheel hex — alternative** | **Traxxas TRA6469** — 17mm splined aluminum wheel hub, 6061-T6 blue-anodized, screw pin 4×13mm w/ threadlock | Wheel-mount hex on both Tekno stubs | N/A | 🔵 In hand, **5.9g measured** (alternative, not chosen). Would shave to the chamfer/bevel edge to seat — same modification works front and rear |

<p align="center"><img src="src/drivetrain_tekno_1654-17_front_hub_adapter.jpg" width="250">&nbsp;<img src="src/drivetrain_tekno_5580_stub_axle.jpg" width="250">&nbsp;<img src="src/drivetrain_tekno_5070_stub_axle.jpg" width="250">&nbsp;<img src="src/drivetrain_traxxas_wheel_hub_17mm_tra6469_weight.jpg" width="250"><br><em>Front: TKR1654-17 17mm M6 adapter · Rear: Tekno 5580 (TKR5570-17 / SCT410) · Tekno 5070 (EB48) · TRA6469 wheel hex (alternative), 5.9g</em></p>
