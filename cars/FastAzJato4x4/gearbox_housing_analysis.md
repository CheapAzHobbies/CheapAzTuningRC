...
<p align="center">
  <img src="src/drivetrain_traxxas_diff_housing_front_tra6881.jpg" height="417">&nbsp;<img src="src/drivetrain_traxxas_diff_housing_rear_tra6880.jpg" height="417"><br>
...
|---|---|---|
| **Fits the chosen stock Jato 4x4 diff** | Must | The diff housing has to accept the stock Jato 4x4 diff bearings + outdrives (back to stock, see [`differential_analysis.md`](differential_analysis.md)) |
...
> *Spec format: Material · Part · Weight · Price*

| Housing | Spec | Pros / Cons | Photo / Link |
|---|---|---|---|
| ⭐ **Traxxas stock plastic** (Slash 4x4 / Jato 4x4 family) | **Material:** Glass-filled nylon<br><br>**Part:** TRA6881 (front) / TRA6880 (rear), two halves each<br><br>**Weight:** Front (TRA6881) **20.0g** · Rear (TRA6880) **20.0g** measured (both halves each)<br><br>**Price:** $4.00 per set | Pro: Cheapest, lightest, **sacrificial in crashes** (same logic as the shock tower and bumper picks). Wide LHS / AMain availability. **Native fit for the chosen stock Jato 4x4 diffs, no surgery needed** (the E-Revo diffs previously in the plan needed minor fitting; the stock diff is the correct native pairing)<br><br>Con: Cracks on hard direct impacts; nylon ages | <img src="src/drivetrain_traxxas_diff_housing_front_tra6881.jpg" height="209"> <img src="src/drivetrain_traxxas_diff_housing_rear_tra6880.jpg" height="209"><br><em>front TRA6881 · rear TRA6880</em><br><img src="src/drivetrain_traxxas_diff_housing_front_tra6881_weight.jpg" width="250"> <img src="src/drivetrain_traxxas_diff_housing_rear_tra6880_weight.jpg" width="250"><br><em>front TRA6881, 20.0g · rear TRA6880, 20.0g</em> |
| ❌ ~~**Wltoys K939 gear box** (assembled shell)~~ | **Material:** Glass-filled nylon<br><br>**Part:** K939-09 (front) / K939-08 (rear)<br><br>**Weight:** N/A<br><br>**Price:** $7.99 each (WL-Toys.com; market $23.97) | Pro: **Drop-in for the same Slash 4x4 family pattern.** I already run this on the K939 with no issues, performs identically. Could be a fallback if the Traxxas OEM is unavailable<br><br>Con: **At $7.99/end it's ~2× the $4 Traxxas housing, no reason to pay more for a clone of an already-cheap part.**, not the cheaper option once you do the math. Ships from China (slow); sometimes back-ordered; bearings not included (source K939-51 etc. separately) | <img src="src/drivetrain_wltoys_k939_front_gearbox_k939-09.jpg" width="250"> <img src="src/drivetrain_wltoys_k939_rear_gearbox_k939-08.jpg" width="250"><br><em>front K939-09 · rear K939-08</em> |
| ❌ ~~**Remo Hobby / HQ727 diff housing** (same car, two brands)~~ | **Material:** Glass-filled nylon<br><br>**Part:** P2013 (front) / P2041 (rear)<br><br>**Weight:** N/A<br><br>**Price:** TBD | Pro: Drop-in compatible with Slash 4x4 / Jato pattern. **Remo Hobby and HQ727 are the same vehicle rebranded**, the housings interchange<br><br>Con: **No cheaper than the $4 Traxxas, so not worth the off-brand hassle** (slow shipping, resale value zero). Front/rear part numbers are easy to mix up, **P2013 = front, P2041 = rear** | <img src="src/drivetrain_remo_hobby_front_diff_housing_p2013.jpg" width="250"> <img src="src/drivetrain_remo_hobby_rear_diff_housing_p2041.jpg" width="250"><br><em>front P2013 · rear P2041</em> |
| ❌ ~~**Generic aluminum housing** (CODA Racing / BRCatWPark / Rcarmumb, same AliExpress part, many Amazon brands)~~ | **Material:** 6061-T6 anodized aluminum, CNC<br><br>**Part:** e.g. CDR6880-6881NB (replaces TRA6880/6881)<br><br>**Weight:** ~156g (5.5 oz) the set<br><br>**Price:** ~$73–113 depending on brand | Pro: Won't crack, one reviewer kept snapping plastic cases. Looks tough<br><br>Con: **Heavy (~156g vs a few grams of plastic), and 18–28× the $4 Traxxas housing.** Wrong failure mode, passes impact to the chassis / arms instead of cracking. And the [CF chassis skid plate already protects the diff from below](chassis_analysis.md). **Some units have no pocket for the center-driveshaft pinion bearing** (flagged in reviews), a real fitment gamble | <img src="src/drivetrain_aluminum_diff_housing_aftermarket.jpg" width="500"> |
---
...
- **Knock-off housings aren't worth it here.** The OEM Traxxas housing is already **$4**, the cheapest of the bunch. The K939 (~$8/end) and Remo/HQ727 clones cost the same or more, so there's nothing to save by going off-brand. **Just buy the Traxxas;** only reach for a clone if the OEM is genuinely unavailable.
...
- **Untested idea, half-and-half housings for jump attitude.** Running an aluminum housing on *one end only* (e.g., alum front + plastic rear) biases weight toward that end, which *might* tune the car's attitude through the air, how it rotates / noses on jumps. Pure theory, **not tested**, and it still carries the weight/CG penalty. File under experiments, not a recommendation.
