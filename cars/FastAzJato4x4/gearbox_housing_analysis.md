...
|---|---|---|---|
| ⭐ **Traxxas stock plastic** (Slash 4x4 / Jato 4x4 family) | **Material:** Glass-filled nylon<br><br>**Part:** TRA6881 (front) / TRA6880 (rear) — two halves each<br><br>**Weight:** Rear (TRA6880) **20.0g** measured (both halves)<br><br>**Price:** $4.00 per set | Pro: Cheapest, lightest, **sacrificial in crashes** (same logic as the shock tower and bumper picks). Wide LHS / AMain availability. **Native fit for the chosen stock Jato 4x4 diffs — no surgery needed** (the E-Revo diffs previously in the plan needed minor fitting; the stock diff is the correct native pairing)<br><br>Con: Cracks on hard direct impacts; nylon ages | <img src="src/drivetrain_traxxas_diff_housing_front_tra6881.jpg" width="250"> <img src="src/drivetrain_traxxas_diff_housing_rear_tra6880.jpg" width="250"><br><em>front TRA6881 · rear TRA6880</em><br><img src="src/drivetrain_traxxas_diff_housing_rear_tra6880_weight.jpg" width="250"><br><em>rear TRA6880 on scale — 20.0g</em> |
