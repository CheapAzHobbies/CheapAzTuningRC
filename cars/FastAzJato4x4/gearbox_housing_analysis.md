...
|---|---|---|---|---|
| **Traxxas stock plastic** (Slash 4x4 / Jato 4x4 family) | Glass-filled nylon | **Leading** | Pro: Cheapest, lightest, **sacrificial in crashes** (same logic as the shock tower and bumper picks). Wide LHS / AMain availability. Fits the chosen E-Revo diffs without surgery<br>Con: Cracks on hard direct impacts; nylon ages | <img src="https://placehold.co/300x200/eee/333?text=IMAGE+NEEDED" width="300"><br>🚧 save as `src/drivetrain_traxxas_stock_gearbox_housing.jpg` |
| **Wltoys K939 OEM diff housing kit** | Glass-filled nylon | Candidate (budget) | Pro: **~$10-15 for a full kit** including bearings and gaskets — cheaper than Traxxas individual parts. Direct fit to the same Slash 4x4 family pattern. User already runs this on the K939 with no issues<br>Con: Sometimes back-ordered; QC slightly more variable than Traxxas factory parts | <img src="https://placehold.co/300x200/eee/333?text=IMAGE+NEEDED" width="300"><br>🚧 save as `src/drivetrain_wltoys_k939_diff_housing_kit.jpg` |
| **Remo Hobby EMU9 housing kit** | Glass-filled nylon | Candidate (budget) | Pro: Drop-in compatible with Slash 4x4 / Jato pattern, cheap (~$15-20), often in stock on AliExpress<br>Con: Remo Hobby branding; resale value zero | <img src="https://placehold.co/300x200/eee/333?text=IMAGE+NEEDED" width="300"><br>🚧 save as `src/drivetrain_remo_hobby_emu9_diff_housing.jpg` |
| **HQ727 (Hosim / HSP 1/8 clone) housing** | Plastic | Candidate (budget) | Pro: Cheapest at ~$10. Often available as a kit with diff internals included<br>Con: Originally designed for the HQ727 1/8 buggy chassis — check Slash 4x4 mount-hole spacing before committing | <img src="https://placehold.co/300x200/eee/333?text=IMAGE+NEEDED" width="300"><br>🚧 save as `src/drivetrain_hq727_gearbox_housing.jpg` |
| ~~Generic aluminum housing from AliExpress~~ | 7075-T6 aluminum | **Vetoed** | Pro: Crash-proof, looks tough, common upgrade<br>Con: **~80% heavier than plastic**, expensive (~$30-50), and the [chosen CF chassis's integrated metal skid plate already protects the diff from below](chassis_analysis.md) — aluminum housing is solving a problem the chassis already handles. Same aluminum-failure-cascade as shock towers: transfers force to chassis / arms instead of cracking the housing | <img src="https://placehold.co/300x200/eee/333?text=IMAGE+NEEDED" width="300"><br>🚧 save as `src/drivetrain_generic_aluminum_gearbox_housing.jpg` |
| ~~Traxxas RPM-branded aftermarket~~ | Reinforced nylon | Candidate (premium plastic) | Pro: RPM's reinforced nylon is genuinely tougher than stock Traxxas at small weight penalty<br>Con: 2-3× the price of OEM Traxxas for marginal improvement on a build where the CF chassis already absorbs hits. Hard to justify | — |
...
- **Cross-brand compatibility:** Slash 4x4, Jato 4x4, Wltoys K939, Remo Hobby EMU9, and HQ727 all use the same gearbox mount-hole pattern and similar internal layouts. Housings are largely interchangeable with minor fitting work.
