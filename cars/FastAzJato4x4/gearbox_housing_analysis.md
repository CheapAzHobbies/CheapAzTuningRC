...
|---|---|---|---|---|
| **Traxxas stock plastic** (Slash 4x4 / Jato 4x4 family) | Glass-filled nylon | **Leading** | Pro: Cheapest, lightest, **sacrificial in crashes** (same logic as the shock tower and bumper picks). Wide LHS / AMain availability. Fits the chosen E-Revo diffs without surgery<br><br>Con: Cracks on hard direct impacts; nylon ages | <img src="https://placehold.co/300x200/eee/333?text=IMAGE+NEEDED" width="500"><br>🚧 save as `src/drivetrain_traxxas_stock_gearbox_housing.jpg` |
| **Wltoys K939 OEM diff housing kit** | Glass-filled nylon | Candidate (budget) | Pro: **~$10-15 for a full kit** including bearings and gaskets — cheaper than Traxxas individual parts. Direct fit to the same Slash 4x4 family pattern. User already runs this on the K939 with no issues<br><br>Con: Sometimes back-ordered; QC slightly more variable than Traxxas factory parts | <img src="https://placehold.co/300x200/eee/333?text=IMAGE+NEEDED" width="500"><br>🚧 save as `src/drivetrain_wltoys_k939_diff_housing_kit.jpg` |
| **Remo Hobby EMU9 housing kit** | Glass-filled nylon | Candidate (budget) | Pro: Drop-in compatible with Slash 4x4 / Jato pattern, cheap (~$15-20), often in stock on AliExpress<br><br>Con: Remo Hobby branding; resale value zero | <img src="https://placehold.co/300x200/eee/333?text=IMAGE+NEEDED" width="500"><br>🚧 save as `src/drivetrain_remo_hobby_emu9_diff_housing.jpg` |
| **HQ727 (Hosim / HSP 1/8 clone) housing** | Plastic | Candidate (budget) | Pro: Cheapest at ~$10. Often available as a kit with diff internals included<br><br>Con: Originally designed for the HQ727 1/8 buggy chassis — check Slash 4x4 mount-hole spacing before committing | <img src="https://placehold.co/300x200/eee/333?text=IMAGE+NEEDED" width="500"><br>🚧 save as `src/drivetrain_hq727_gearbox_housing.jpg` |
