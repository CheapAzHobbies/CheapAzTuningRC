...
<p align="center"><img src="src/suspension_gpm_pushrod_tierod_stainless_er2160s.jpg" width="600"><br><em>GPM stainless adjustable tie rods & push rods, 8-pc set (#ER2160S-OC-BEBK)</em></p>
...
|---|---|---|
| **Won't bend or snap** | Must | Broken/bent rods are the #1 linkage failure on a heavy E-Revo; **extra-thick stainless holds where aluminum snaps and plain steel bends** |
| **Corrosion / rust resistant** | Must | The regular spot is the dirt track, but the car also sees **beach** running. Salt and sand rust plain steel fast; stainless rods + plastic ends shrug it off |
...
|---|---|---|---|
| ⭐ **GPM stainless steel** (8-pc tie + push rod set) | **Type:** tie + push rod set (8 pc)<br>**Material:** stainless steel<br>**MPN:** ER2160S-OC-BEBK<br>**Fits:** E-Revo 1.0 & 2.0 (same eye-to-eye)<br>**Adjustable:** yes (turnbuckles)<br>**Length:** same eye-to-eye on 1.0 & 2.0<br>**Price:** $37.29 (8 pc) | Pro: **Never bent one**, strongest of the three. Stainless won't rust, fully adjustable, and it's a **full kit**: every tie rod and push rod for the whole car in one box (all 8). Works **far better than stock or aluminum**<br><br>Con: Priciest option and **noticeably heavier** overall than aluminum/stock, a weight I accept for the strength; comes with stiff plastic ends I swap for RPM | <img src="src/suspension_gpm_pushrod_tierod_stainless_er2160s.jpg" width="500"> |
| 🔵 **Traxxas aluminum pushrods** (TRA5318X) | **Type:** pushrods (2/pack; buy 2 for front + rear)<br>**Material:** 7075-T6 aluminum (red)<br>**MPN:** TRA5318X<br>**Fits:** P1 / P2 / LT rockers, Revo / E-Revo / Summit<br>**Adjustable:** N/A<br>**Length:** 102 mm<br>**Price:** $12.50 (2 rods) | Pro: Light, looks good, rod ends pre-installed, **correct for the Progressive-2 rockers**<br><br>Con: **Aluminum snaps** on hard hits, the exact failure the GPM stainless eliminates; **pushrods only** (no tie rods in the pack) | <img src="src/suspension_traxxas_aluminum_pushrods_tra5318x.jpg" width="500"><br><em>TRA5318X red 7075-T6 pushrods, 102 mm (2)</em> |
| 🔵 **Traxxas stock rods** (steel) | **Type:** pushrods + toe links + rod ends<br>**Material:** plain steel<br>**MPN:** TRA5318 (pushrods) / TRA5338 (toe links) / TRA5348 (rod ends)<br>**Fits:** Revo / E-Revo<br>**Adjustable:** N/A<br>**Length:** N/A<br>**Price:** pushrods $7 (2) · toe links $10 (2) · rod ends $2 (4) | Pro: Came on the car, **won't snap like aluminum**, dirt cheap<br><br>Con: **Plain steel rusts at the beach** (not stainless) and **can still bend**; stock rod ends break eventually. The extra-thick GPM stainless is the corrosion-proof, full-kit step up | <img src="src/suspension_traxxas_stock_steel_pushrods_tra5318.jpg" width="250"> <img src="src/suspension_traxxas_stock_steel_toe_links_tra5338.jpg" width="250"> <img src="src/suspension_traxxas_stock_rod_ends_tra5348.jpg" width="250"><br><em>pushrods TRA5318 · toe links TRA5338 · rod ends TRA5348</em> |
...
| ❌ ~~**Traxxas stock rod ends** (TRA5348 large, 4-pc)~~ | Pro: OEM fit, **dirt cheap at $2 / 4**, stiff and precise when new<br><br>Con: **Super weak: tend to pull out of the threads / pop off the rod.** The original weak point the RPM ends fix | <img src="src/suspension_traxxas_stock_rod_ends_tra5348.jpg" width="500"><br><em>Traxxas TRA5348 large rod ends (4)</em> |
