...
- **The one thing to stock: steel hex inserts.** With the alloy rockers, the only real consumable is the **replaceable steel hex** the bolt threads into. Keep a few on hand — if you ever strip a thread, swap the cheap hex instead of the whole rocker.
