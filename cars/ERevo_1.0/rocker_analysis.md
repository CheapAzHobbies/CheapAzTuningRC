...
- **Single-fork alloys share one weakness.** Both the GPM and the Enron multi-mount long-travel (Hot Racing-style) use a **single fork** to capture the push-rod ball — and that lone prong is **the part that bends and snaps**. The standard Progressive-2 Enron set avoids this with its fuller capture, which is a big part of why it's the pick. The multi-mount's only draws are adjustability and (maybe) lower weight, but it changes the suspension to a long-travel geometry rather than a stock-rate swap.
