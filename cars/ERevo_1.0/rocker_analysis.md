...
<p align="center"><img src="src/suspension_enron_rocker_alloy_front_rear_5358.png" width="600"><br><em>Enron aluminum #5358, Progressive 2 (90-T) — front + rear (silver in hand; also orange / green / red / blue)</em></p>
...
> *Spec format: Type · Material · Rate · Pivot/Hardware · Fits · Colors · Weight · Price*

| Rocker | Spec | Pros / Cons | Photo / Link |
|---|---|---|---|
| ⭐ **Enron aluminum #5358** (Progressive 2, front + rear) — *silver, in hand* | **Type:** alloy rocker (front + rear, 4P)<br>**Material:** CNC aluminum<br>**Rate:** Progressive 2 (90-T)<br>**Pivot/Hardware:** replaceable steel hex inserts where the bolt threads<br>**Fits:** Revo / E-Revo / E-Revo 2.0 / Slayer Pro / Summit<br>**Colors:** silver / orange / green / red / blue<br>**Weight:** 13.7 g front / 13.5 g rear (single, bare) + hardware ~2.5 g/rocker (~5 g per pair)<br>**Price:** $14.31 paid (silver 4P, May 2026); list ~$25–27.85 | Pro: **Won't crack** — ends the 4–5-sets-a-year plastic replacement cycle. **Replaceable steel hex inserts** where the bolt threads, so a stripped thread = swap the cheap hex, not the rocker<br><br>Con: **+4.4 g front / +6.5 g rear per corner** over plastic (bare); steel hardware adds more; 2×+ the price; not sacrificial — passes impact to the tower | <img src="src/suspension_enron_rocker_alloy_front_rear_5358.png" width="250"> <img src="src/suspension_enron_rocker_alloy_pair_hardware.jpg" width="250"> <img src="src/suspension_enron_rocker_alloy_pair_hardware_bagged.jpg" width="250"><br><em>front + rear · pair + hardware 32.0 g · 32.3 g bagged</em> |
| ❌ ~~**GPM aluminum** (ER2027F front / ER2027R rear)~~ | **Type:** alloy rocker — MPN ER2027F (front) / ER2027R (rear), sold as separate sets<br>**Material:** CNC aluminum<br>**Rate:** N/A<br>**Pivot/Hardware:** brass bushings, 3-hole adjustable mount, single fork<br>**Fits:** E-Revo 1.0 (56087-1) / VXL 2.0<br>**Colors:** blue / orange / grey / black / green<br>**Weight:** N/A<br>**Price:** $26.01/set ($23.41 ea at 4+) — ~$52 for front + rear | Pro: **Brass bushings** for a smooth pivot; captures the push-rod ball end **similar to the Enron kit**; multi-hole adjustable shock mount<br><br>Con: **Single fork** (one prong) vs the OEM's two-sided capture — the ball/bolt is supported on only one side, so **the bolts bend** (and the fork can snap); ~$52 front + rear is **3–4× the Enron's $14.31**; bought as separate front/rear sets | <img src="src/suspension_gpm_rocker_alloy_front_er2027f.jpg" width="250"> <img src="src/suspension_gpm_rocker_alloy_rear_er2027r.jpg" width="250"><br><em>GPM front #ER2027F · rear #ER2027R</em> |
| ❌ ~~**Enron multi-mount long-travel** #5358 (Hot Racing-style)~~ | **Type:** multi-mount, long-travel alloy rocker (4-hole adjustable arm)<br>**Material:** CNC aluminum<br>**Rate:** N/A<br>**Pivot/Hardware:** multi-mount, single fork<br>**Fits:** Revo 3.3 / E-Revo 2.0 / Slayer Pro / Summit<br>**Colors:** silver / blue<br>**Weight:** likely lighter than the standard alloy (unconfirmed)<br>**Price:** $26.18 set (list $41.56), extra 10% at 10+ | Pro: **Adjustable multi-mount** for tuning travel/leverage; **likely lighter** than the standard alloy (unconfirmed); same brand as the chosen Enron<br><br>Con: **Same single-fork design as the GPM** — one-sided capture **bends the bolts**; "long travel" geometry is a **different intent** than a stock-rate replacement; pricier than the $14.31 standard 4P | <img src="src/suspension_enron_rocker_alloy_multimount_long_travel_5358.png" width="500"><br><em>New Enron multi-mount long-travel #5358 (front + rear, silver)</em> |
| ❌ ~~**Traxxas OEM plastic #5358** (Progressive 2, front + rear set)~~ — *lighter option only* | **Type:** OEM rocker set (front + rear); includes 8 red aluminum spacers<br>**Material:** glass-filled composite<br>**Rate:** Progressive 2 (90-T)<br>**Pivot/Hardware:** N/A<br>**Fits:** Revo / E-Revo<br>**Colors:** N/A<br>**Weight:** 9.3 g front / 7.0 g rear (single, bare)<br>**Price:** $11.00 (full set) | Pro: **Lightest option**, cheap, OEM-correct, comes with the spacer set, sacrificial in crashes<br><br>Con: **Cracks regularly — 4–5 sets/year**, which is exactly why it's no longer the pick | <img src="src/suspension_traxxas_rocker_oem_plastic_front.jpg" width="250"> <img src="src/suspension_traxxas_rocker_oem_plastic_rear.jpg" width="250"><br><em>front 9.3 g · rear 7.0 g</em> |
...
|---|---|---|---|
| ⭐ **Traxxas oilite bronze bushings** | **Type:** oilite bushings, 5×11×4 mm — part TRA1675 (14)<br>**Material:** self-lubricating sintered bronze<br>**Rate:** N/A<br>**Pivot/Hardware:** rocker pivot bushing<br>**Fits:** rocker pivots<br>**Colors:** N/A<br>**Weight:** N/A<br>**Price:** $5.00 | Pro: **Limits movement** — tight, no play. Bronze is **softer than the steel stud**, so the bushing wears itself, **never the stud**. Self-lubricating and tolerant of dirt<br><br>Con: More friction than a bearing — irrelevant on a slow rocker pivot | <img src="src/suspension_traxxas_oilite_bushings_5x11x4.jpg" width="500"> |
| ❌ ~~**Traxxas ball bearings 5×11×4 mm** (#4607)~~ | **Type:** ball bearings, 5×11×4 mm — part TRA4607<br>**Material:** metal-shielded steel<br>**Rate:** N/A<br>**Pivot/Hardware:** rocker pivot bearing<br>**Fits:** rocker pivots<br>**Colors:** N/A<br>**Weight:** N/A<br>**Price:** $24.00 (8) | Pro: Nice when new on a clean track — low friction, smooth<br><br>Con: **Practically seizes almost immediately** once grit gets in, and eventually **damages the rocker pivot point**; the tracks I run are filthy, so it never lasts | <img src="src/suspension_traxxas_ball_bearings_5x11x4_4607.jpg" width="500"> |
...
- **No need to stock plastic spares anymore.** The alloy rockers should last years, so there's no point keeping a shelf of $11 plastic sets as the old yearly-replacement insurance. Plastic stays only as a one-off lightweight option if you ever want to drop weight for a specific track.
- **The one thing to stock: steel hex inserts.** With the alloy rockers, the only real consumable is the **replaceable steel hex** the bolt threads into. Keep a few on hand — if you strip a thread, swap the cheap hex instead of the whole rocker. They're also small and easy to drop/lose, so it's just nice to have extras around.
- **Enron hardware tip.** The set ships with **15 mm screws, but 16 mm fits better** — swap up if you have them. Either way, **thread-lock the screws** (Vibra-Tite VC-3 or Loctite) so they don't back out under vibration.
