...
- **Connector note:** the MAX8 G2S is on **XT90** and the Premos are **XT60**, so this car is already adapting. The SMC can be ordered in XT90 for +$1.50, which would be the first pack here to match the ESC directly. Its free SC5 option is EC5/IC5-compatible, which suits the Jato fleet's EC5 packs, not this car.
