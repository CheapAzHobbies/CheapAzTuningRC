...
- **No aluminum arms here, on purpose.** Skipped the alloy arm options because they're **expensive, add tons of weight, and just aren't worth it** when **the stock arms rarely break, if at all**. The only real arm issue is the **pillow balls popping out**, and that's an easy fix: **super glue them and screw them back in** and they hold fine.
