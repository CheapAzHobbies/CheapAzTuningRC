...
<p align="center"><img src="src/body_traxxas_solar_flare_8612.jpg" width="600"><br><em>Traxxas 8612 E-Revo Solar Flare — pre-painted ProGraphix with decals, front + rear clipless mounts and roof skid pre-installed</em></p>
...
> *Spec format: Type · Material · Finish · Includes · Fits · Price*

| Body | Spec | Pros / Cons | Photo / Link |
|---|---|---|---|
| ⭐ **Traxxas 8612 E-Revo 2.0 "Solar Flare"** (pre-painted) | **Type:** pre-painted body<br>**Material:** polycarbonate<br>**Finish:** ProGraphix paint + decals applied<br>**Includes:** front + rear clipless body mounts, roof skid, reinforcement<br>**Fits:** E-Revo 2.0<br>**Price:** $79.95 (PowerHobby, currently **out of stock**) | Pro: **Pre-painted with decals** (zero paint labor). Ships with the **reinforcement, clipless mounts, and roof scratch skid** built in. Works out **cheaper than buying those bits + painting a 1.0 body separately**. Like the Solar Flare scheme<br><br>Con: **2.0 style, not the OG look** I prefer; the shell still wears out; $79.95 and out of stock at PowerHobby right now | <img src="src/body_traxxas_solar_flare_8612.jpg" width="500"> |
| 🔵 **Aftermarket E-Revo 1.0 body (OG style) + paint** | **Type:** aftermarket bare shell + paint<br>**Material:** polycarbonate<br>**Finish:** unpainted — paint ~$14 (DIY) / ~$50 painted for you<br>**Includes:** none<br>**Fits:** E-Revo 1.0<br>**Price:** ~$39 DIY total (~$25 shell + ~$14 paint) + labor | Pro: **Preferred OG style**; cheapest bare shell; paint it any scheme (e.g. Solar Flare)<br><br>Con: **No factory reinforcement / clipless / roof skid** (buy those separately = the total creeps past the whole 2.0 body); paint time and skill required; least protected out of the box | <img src="https://placehold.co/500x300/eee/333?text=IMAGE+NEEDED" width="500"><br>🚧 save as `src/body_aftermarket_erevo_1_0_og_style.jpg` |
| 🟢 **Stock original E-Revo body** (current) | **Type:** stock OEM body (already on the truck)<br>**Material:** polycarbonate<br>**Finish:** OEM painted (worn)<br>**Includes:** none (no clipless mounting)<br>**Fits:** E-Revo 1.0<br>**Price:** $0 (owned) | Pro: **Already mounted**, OG look, no cost<br><br>Con: Worn from use; no clipless mounting; getting beat up | <img src="https://placehold.co/500x300/eee/333?text=IMAGE+NEEDED" width="500"><br>🚧 save as `src/body_traxxas_erevo_stock_original.jpg` |
