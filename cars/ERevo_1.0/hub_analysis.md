...
| 🔵 **Aftermarket aluminum carriers** (Enron 5334 / 5334R) — *candidate, verify service-part fit* | Material: CNC aluminum<br><br>Bearings: **oversized** (takes the same big bearings)<br><br>Fits Revo 3.3 / Summit / T-Maxx / Slayer<br><br>Colors: silver / blue / red<br><br>Price: ~**$10–18** (AliExpress, with coupons) | Pro: **Metal (won't crack)** and **runs the same oversized bearings** as the RPM; price is about the same<br><br>Open question: **verify the RPM 80010 setscrew + bushing-cap service kit fits these.** If it does, it's a strong metal option; if not, a worn pillow-ball bore could mean a whole new hub instead of a cheap rebuild | <img src="src/steering_enron_alloy_carriers_5334.jpg" width="500"> |
