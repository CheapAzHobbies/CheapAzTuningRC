...
| ❌ ~~**Aftermarket aluminum carriers** (Enron 5334 / 5334R)~~ — *considered, not worth it* | Material: CNC aluminum<br><br>Fits Revo 3.3 / Summit / T-Maxx / Slayer<br><br>Colors: silver / blue / red<br><br>Price: ~**$10–18** (AliExpress, with coupons) | Pro: Metal, won't crack; price is about the same as the RPM<br><br>Con: **No guaranteed service parts.** With the RPM/plastic carriers you replace the cheap setscrew + cap (RPM 80010) when the pillow-ball bore wears; there's **no guarantee that kit fits the metal ones**, so a worn bore could mean a whole new hub. Same price as RPM but worse to service, so not worth it | <img src="src/steering_enron_alloy_carriers_5334.jpg" width="500"> |
