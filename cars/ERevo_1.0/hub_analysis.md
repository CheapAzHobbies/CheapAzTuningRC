...
<p align="center">
  <img src="src/steering_enron_alloy_carriers_5334.jpg" height="317">&nbsp;<img src="src/suspension_rpm_truetrack_rear_arm_80562.jpg" height="317"><br>
...
> **RPM 80010 Pillow Ball Set Screws & Bushing Caps** is a **service/consumable item**, not pillow balls. The setscrew + Delrin cap are what **capture the pillow ball inside the carrier**; the idea is you replace just these instead of whole new pillow balls (roughly half the cost).
...
- **Don't order stock bearing sizes** (TRA5117 6×12×4 / TRA5120 12×18×4) for these carriers, they're too small. Those still get stocked for the [Jato 4x4](../Jato4SS/README.md), which runs them.
