...
- **Measured kit weight:** parts as weighed sum to **58.8 g** (carriers 35.1 + bearings 19.1 + setscrews 3.3 + caps 1.3). A **fully built corner** (carrier + 1 outer + 1 inner bearing + 2 setscrews + 2 caps) ≈ **20.6 g**, so **all 4 corners ≈ 82.5 g** (carriers 35.1 + 8 bearings 38.2 + 8 setscrews 6.6 + 8 caps 2.6). The bearing/hardware photos covered 2 carriers' worth, doubled for four. *Assumes 2 bearings + 2 setscrews + 2 caps per carrier; the True-Track rear corners run a pin instead of the lower pillow ball, so they'd shed one setscrew/cap each.*
