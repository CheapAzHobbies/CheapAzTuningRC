...
| Position | Stock Traxxas | RPM oversized (80582 + True Track) | Change |
|---|---|---|---|
| **Outer** (wheel side) | **6×12×4 mm** (TRA5117) | **6×15×5 mm** | same 6 mm bore, **+3 mm OD, +1 mm width** |
| **Inner** | **12×18×4 mm** (TRA5120) | **12×21×5 mm** | same 12 mm bore, **+3 mm OD, +1 mm width** |
...
| 🔵 **Traxxas 5334R axle carriers** — *the Traxxas upgrade of the stock part; reference only* | Material: black composite<br><br>Bearings: **6×13 mm** outer (sold separately); ships with **6×12 mm bearing adapters (2)** to run the older stock-size bearing<br><br>Includes: **4 dust boot retainers**<br><br>L&R set, fits Revo / E-Revo | The Traxxas-upgraded stock carrier, bored for the larger **6×13** bearing with adapters down to 6×12. **Different bearing size than the RPM oversized 6×15×5**, so don't mix bearings between them. Listed for reference; the build runs RPM | <img src="src/steering_traxxas_axle_carriers_5334r.jpg" width="500"> |
| 🔵 **Stock Traxxas carriers** (TRA5334) — *stock baseline; reference only* | Bearings: **stock** 6×12×4 outer / 12×18×4 inner<br><br>Walls: thinner than RPM<br><br>L&R set, fits front + rear<br><br>Price: **$8.00** | The OEM carrier. Cheap and uses common stock-size bearings, but the walls can split and let the pillow balls pull through under impact, and the smaller bearings wear faster on a heavy truck (the reason for the move to RPM / oversized). Listed for reference | <img src="src/steering_traxxas_carriers_stock_tra5334.jpg" width="500"> |
...
- **Decision: RPM plastic, both ends.** Lighter (less unsprung weight) with a bit of give that protects other parts, worth the marginally lower stiffness. The stock **TRA5334** and its Traxxas upgrade **TRA5334R** are listed for reference only, not in the running.
