...
|---|---|---|---|
| ⭐ **RPM 80582 steering blocks / axle carriers** (black) — *front, in hand* | **Type:** steering blocks / axle carriers (set of 4)<br>**Material:** composite<br>**Bearing sizes:** oversized 6×15×5 outer / 12×21×5 inner (included)<br>**Hex:** 14 mm<br>**Fits:** Revo / E-Revo / T-Maxx 2.5R/3.3 / E-Maxx / Slayer<br>**Pivot/Hardware:** walls **+40%** thickness around pillow balls; pillow-ball support **+20% material** (no pull-through); two-piece aluminum + Delrin set screws<br>**Brand:** RPM<br>**Colors:** black<br>**Toe:** N/A<br>**Warranty:** lifetime against breakage<br>**Includes:** oversized bearings<br>**Weight:** 35.1 g / set of 4 (~8.8 g ea)<br>**Price:** $23.75 (PowerHobby) | Pro: **Oversized bearings** (double load rating) in a **much stronger carrier** that stops the pillow balls tearing out. Normally does **both ends**; here it runs the **front**. Press-fit seats reduce slop<br><br>Con: Replacement bearings are **non-stock oversized sizes** (plan ahead); composite, not alloy | <img src="src/steering_rpm_axle_carriers_steering_blocks_80582.jpg" width="250"> <img src="src/steering_rpm_axle_carriers_steering_blocks_80582_weight.jpg" width="250"><br><em>product · 35.1 g/set</em> |
| ⭐ **RPM True Track rear axle carriers** (in the 80562 kit) — *rear, in hand* | **Type:** rear axle carriers (bundled with the rear A-arms, no separate purchase)<br>**Material:** composite<br>**Bearing sizes:** same oversized 6×15×5 / 12×21×5 (included)<br>**Hex:** 14 mm<br>**Fits:** True Track pin geometry only<br>**Pivot/Hardware:** lower mount = **4 mm hinge pin** (not a pillow ball)<br>**Brand:** RPM<br>**Colors:** N/A<br>**Toe:** fixed 3° (pin-locked)<br>**Warranty:** lifetime against breakage<br>**Includes:** oversized bearings (in the 80562 kit)<br>**Weight:** carriers 32.3 g/pr + bearings (inner 11.7 + outer 7.3) = **~51.3 g** rear hubs (measured)<br>**Price:** N/A (in the 80562 kit) | Pro: **Comes as part of the True Track deal** (cheaper than buying rear carriers alone), same oversized bearings, and the pin locks rear toe. "Beefy" rear carriers<br><br>Con: Only fits the True Track pin geometry; rear toe becomes fixed (see [`arm_analysis.md`](arm_analysis.md)) | <img src="src/suspension_rpm_truetrack_rear_arm_80562.jpg" width="200"> <img src="src/steering_rpm_truetrack_rear_axle_carriers_80562_weight.jpg" width="200"><br><em>True Track rear · carriers 32.3 g/pr</em> |
| 🔵 **Enron metal carriers** (no part #) — *reference; largest bearings* | **Type:** axle carriers (no part #)<br>**Material:** aluminum / metal<br>**Bearing sizes:** largest — 6×15×5 / 12×21×5 (same as RPM)<br>**Hex:** 14 mm<br>**Fits:** Revo / E-Revo / Summit / T-Maxx / Slayer<br>**Pivot/Hardware:** N/A<br>**Brand:** Enron<br>**Colors:** N/A<br>**Toe:** N/A<br>**Warranty:** N/A<br>**Includes:** N/A<br>**Weight:** heavier than RPM plastic<br>**Price:** N/A (no part number to reorder) | Pro: **Metal won't crack**; takes the **same largest 6×15×5 / 12×21×5 bearings as the RPM**<br><br>Con: **Heavier than RPM plastic** (more unsprung weight); **no part number** to reorder. Reference only; the build runs RPM | <img src="src/steering_enron_alloy_carriers_5334.jpg" width="500"> |
