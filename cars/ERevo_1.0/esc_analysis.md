...
- **Cheaper + lighter combo option:** Hobbywing sells the **MAX8 G2S + 4274SD G2R** combo direct for **$187** (code **HWTRYOUTS**) — ~$22 under the 4278SD/$208.99 deal. The **4274SD is also 2250KV** (same speed as the 4278SD), just a **shorter/lighter can** (74 mm / 396 g vs 78 mm / 455 g). So same KV, ~59 g lighter, cheaper — arguably the better E-Revo buy unless you want the 4278's extra thermal mass for sustained MT abuse.
