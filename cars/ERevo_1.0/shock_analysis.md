...
| 🥈 **Hot Bodies D8 97mm** (metal big bore, HBS67296) | Bore: **16 mm**<br><br>Body: **metal**, threaded<br><br>Same 16mm internals as the C1 | Pro: Metal body **never dents** and the shock end shims a touch more precisely with M3×1; identical big-bore internals<br><br>Con: **Heavier** than the plastic C1 — and the shocks are protected here, so that toughness buys nothing. **Worse on the Revo specifically:** the shocks sit inboard up top on the rocker linkage, so the metal body's extra weight rides right on the moving rocker/pushrod mass — the unique suspension makes the weight penalty count more, not less. Discontinued. **Also no correct springs included** (same Acxess swap) | <img src="src/suspension_hb_d8_shocks_hbs67296.jpg" width="500"> |
