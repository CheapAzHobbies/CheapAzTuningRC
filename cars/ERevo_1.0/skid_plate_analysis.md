...
- **Usage-based lifespan, not just calendar time: the rear metal plate wore out over ~39 battery-pair sessions.** During the plate's May 27 - Sep 7 tracked window, the Zeee Premo pair logged +36 cycles (70 → 106) and the HOOVO pair +3 (acquired 8/31/26), per [`batteries/README.md`](../../batteries/README.md). The tracker started 17 days after the skid plate did (5/10 → 5/27), so the real total is 39 or a little more.
- **The E-Revo's total lifetime run count is the raw cycle numbers themselves, not a delta.** The Zeee Premo pair and the HOOVO pair are the **only** battery pairs ever run in this car, so their cycle counts directly are the count of times it's been driven: **106 (Premo, since acquired 6/21/23) + 3 (HOOVO, since 8/31/26) = 109 total sessions, full lifetime.** The 39-session figure above is just the slice of that total that fell inside this one plate's service window, not a separate count.
