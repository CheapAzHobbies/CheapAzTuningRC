...
| ⭐ **Traxxas 5337 (plastic)** — *chosen* | **Type:** plastic skid plate set<br>**Material:** nylon / plastic<br>**Position:** front + rear<br>**Fits:** Revo 1.0, 2.0, 3.3<br>**Includes:** front + rear<br>**Weight:** N/A<br>**Price:** ~$8 / set | Pro: Cheap, flexible, includes both front + rear, easy to replace<br><br>Con: None for this use case | <img src="src/skidpalteset.jpg" width="250"><br><em>Traxxas 5337 plastic skid plate set (front + rear)</em> |
