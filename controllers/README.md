...
- **Rebuild a stock TQ / TQi instead of replacing it.** Out of the box it **really sucks** — notchy, dry, vague off-center — and that's the feel, not the electronics. **Re-grease it and run bearings in place of the factory bushings at the wheel and trigger, and it feels like a pro controller.** A couple of dollars and an evening against $150+ for a mid-tier radio, and the TQi keeps its Bluetooth telemetry. **The catch is the same as ever:** it's still 2-3 channels, still locked to Traxxas receivers, and still has no screen. **A rebuild fixes how it feels, not what it does.** 🚧 Bearing sizes not recorded yet, measure before ordering.
